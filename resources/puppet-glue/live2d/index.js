...
import { CubismFramework, LogLevel, Option } from "../sdk/framework/live2dcubismframework";
...
import { BreathParameterData, CubismBreath } from "../sdk/framework/effect/cubismbreath";
import {
...
class Live2DPuppetInstance {
  ...
  reportPaint() {
    ...
    this.draw = (delta) => {
      ...
      const line =
        `painted ${width}x${height}: ${opaque} opaque px, ` +
  ...
  async load() {
    ...
    model._breath.setParameters([
      ...
      new BreathParameterData(
        ids.getId(CubismDefaultParameterId.ParamBodyAngleX),
        0,
        4,
        15.5345,
        0.5
