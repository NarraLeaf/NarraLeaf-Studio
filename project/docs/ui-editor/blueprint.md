...
| Category | Use for |
| --- | --- |
| `Events` | Event entry heads such as `Init`, `Unmount`, `Mouse Click`, `Right Click`, `On Key Down`, `Any Key Down`, `Surface Init`, `Before Surface Exit`, `After Surface Enter`, `App Boot`, broadcast receivers, and `Page Event`. |
