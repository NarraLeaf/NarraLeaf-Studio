...
export const runZsign: ZsignRunner = (executable, args) =>
  new Promise<ZsignRun>((resolve) => {
  ...
  try {
    ...
    await fs.writeFile(
      ...
      writePasswordlessPkcs12({
        ...
        certificateChainDer: identity.certificateChainDerBase64.map((der) =>
    ...
    const args = [
      ...
      ephemeralP12,
      "-m",
      signing.provisioningProfileFile,
      "-b",
      options.bundleId,
      "-n",
      options.displayName,
      "-o",
      options.signedIpaPath,
