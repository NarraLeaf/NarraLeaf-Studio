...
async function buildTemplateApk(extra: ZipWriteEntry[] = []): Promise<Buffer> {
    const entries: ZipWriteEntry[] = [
        ...
        { name: "lib/arm64-v8a/libnlcrypto.so", source: { kind: "buffer", data: NATIVE_BYTES }, method: "store" },
        { name: "lib/x86_64/libnlcrypto.so", source: { kind: "buffer", data: NATIVE_BYTES }, method: "store" },
