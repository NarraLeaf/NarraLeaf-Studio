...
const GITHUB_LATEST_RELEASE_API =
  "https://api.github.com/repos/NarraLeaf/NarraLeaf-Studio/releases/latest";
...
export class UpdateManager {
  ...
  private async checkViaGitHub(): Promise<UpdateState> {
    this.setState({ status: "checking", error: undefined });
    try {
      const url = applyDownloadRewrite(GITHUB_LATEST_RELEASE_API, (message) =>
        this.app.logger.info("[Update]", message)
      );
