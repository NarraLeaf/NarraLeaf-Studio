...
export const LORE_STRUCTS = {
  ...
  LoreRepositoryConfigGetArgs: { key: "LoreString" },
  ...
  LoreBranchPushArgs: { branch: "LoreString", fastForwardMerge: "uint8_t" },
  ...
  LoreRepositoryCloneBeginEventData: {
    repository: "LoreRepositoryId",
    branch: "LoreString",
    revision: "LoreHash",
    path: "LoreString"
  },
  LoreRepositoryCloneProgressEventData: { count: "LoreRepositoryCloneCountData" },
  LoreRepositoryCloneEndEventData: {
    branch: "LoreString",
    revision: "LoreHash",
    count: "LoreRepositoryCloneCountData"
  },
  LoreRepositoryConfigGetEventData: { key: "LoreString", value: "LoreString" },
  ...
  LoreRevisionSyncFileEventData: {
    path: "LoreString",
    size: "uint64_t",
    action: "LoreFileAction",
    flagFile: "uint8_t"
  },
  LoreRevisionSyncProgressEventData: {
    fileUpdate: "uintptr_t",
    fileUpdateTotal: "uintptr_t",
    fileDelete: "uintptr_t",
    fileDeleteTotal: "uintptr_t",
    fileAutomerge: "uintptr_t",
    fileConflict: "uintptr_t",
    bytesUpdate: "uint64_t",
    bytesUpdateTotal: "uint64_t",
    discoveryComplete: "uint8_t"
  },
  ...
  LoreBranchPushEventData: {
    ...
    remoteHistory: "uint64_t",
    localHistory: "uint64_t",
    flagAlreadyPushed: "uint8_t",
    flagDefault: "uint8_t",
    flagLink: "uint8_t",
    flagLayer: "uint8_t"
  },
  ...
  LoreStorageGetHeaderEventData: {
    id: "uint64_t",
    address: "LoreAddress",
    sizeContent: "uint64_t"
  },
  ...
  LoreBranchMergeAbortBeginEventData: {
...
export const LORE_EVENT_TAGS = {
  ...
  AUTH_IDENTITY: 10,
  BRANCH_PUSH: 65,
  REPOSITORY_CLONE_BEGIN: 132,
  REPOSITORY_CLONE_PROGRESS: 133,
  REPOSITORY_CLONE_END: 134,
  REPOSITORY_CONFIG_GET: 139,
...
export const LORE_VERBS = {
  ...
  revisionMetadataSet: {
    symbol: "lore_revision_metadata_set",
    args: "LoreRevisionMetadataSetArgs"
  },
  revisionMetadataGet: {
    symbol: "lore_revision_metadata_get",
    args: "LoreRevisionMetadataGetArgs"
  },
  revisionMetadataList: {
    symbol: "lore_revision_metadata_list",
  ...
  revisionTreeResolvePath: {
    symbol: "lore_revision_tree_resolve_path",
    args: "LoreRevisionTreeResolvePathArgs"
  },
  revisionTreeNodeInfo: {
    symbol: "lore_revision_tree_node_info",
  ...
  branchMergeResolveMine: {
    symbol: "lore_branch_merge_resolve_mine",
    args: "LoreBranchMergeResolveMineArgs"
  },
  branchMergeResolveTheirs: {
    symbol: "lore_branch_merge_resolve_theirs",
  ...
  branchMergeUnresolve: {
    symbol: "lore_branch_merge_unresolve",
  ...
  // globals; the rest of Studio's calls deliberately run offline (see VcsManager).
  repositoryClone: { symbol: "lore_repository_clone", args: "LoreRepositoryCloneArgs" },
  repositoryConfigGet: {
    symbol: "lore_repository_config_get",
