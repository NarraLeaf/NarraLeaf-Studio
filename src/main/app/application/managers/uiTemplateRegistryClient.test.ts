...
describe("resolveTemplateRegistryUrl", () => {
  ...
  it("uses a configured value verbatim", () => {
    expect(resolveTemplateRegistryUrl("https://example.com/i.json")).toBe(
...
describe("fetchTemplateBundle", () => {
  ...
  it("resolves document + graphs against the index directory", async () => {
    const base =
      "https://raw.githubusercontent.com/NarraLeaf/UI-Templates/master/templates/narraleaf.save-load";
