...
async function ensurePathAllowed<T>(
  window: AppWindow,
  fsPath: string,
  mode: "read" | "write"
...
async function ensurePathsAllowed<T>(
  window: AppWindow,
  mode: "read" | "write",
  ...paths: string[]
): Promise<FsRequestResult<T> | null> {
...
export class FsStatHandler extends IPCHandler<IPCEventType.fsStat> {
  ...
  public async handle(
    window: AppWindow,
    { path }: IPCEvents[IPCEventType.fsStat]["data"]
  ): Promise<RequestStatus<FsRequestResult<FileStat>>> {
...
export class FsListHandler extends IPCHandler<IPCEventType.fsList> {
  ...
  public async handle(
    window: AppWindow,
    { path }: IPCEvents[IPCEventType.fsList]["data"]
  ): Promise<RequestStatus<FsRequestResult<FileEntry[]>>> {
...
export class FsDetailsHandler extends IPCHandler<IPCEventType.fsDetails> {
  ...
  public async handle(
    window: AppWindow,
    { path }: IPCEvents[IPCEventType.fsDetails]["data"]
  ): Promise<RequestStatus<FsRequestResult<FileDetails>>> {
...
export class FsDirectorySizeHandler extends IPCHandler<IPCEventType.fsDirectorySize> {
  ...
  public async handle(
    window: AppWindow,
    { path }: IPCEvents[IPCEventType.fsDirectorySize]["data"]
  ): Promise<RequestStatus<FsRequestResult<DirectorySizeResult>>> {
...
export class FsRequestReadHandler extends IPCHandler<IPCEventType.fsRequestRead> {
  ...
  public async handle(
    window: AppWindow,
    { path, raw, encoding }: IPCEvents[IPCEventType.fsRequestRead]["data"]
  ): Promise<RequestStatus<FsRequestResult<string>>> {
...
export class FsRequestReadDirHandler extends IPCHandler<IPCEventType.fsRequestReadDir> {
  ...
  public async handle(
    window: AppWindow,
    { path }: IPCEvents[IPCEventType.fsRequestReadDir]["data"]
  ): Promise<RequestStatus<FsRequestResult<string>>> {
    const denied = await ensurePathAllowed<string>(window, path, "read");
    if (denied) return this.success(denied);
...
export class FsRequestWriteHandler extends IPCHandler<IPCEventType.fsRequestWrite> {
  ...
  public async handle(
    window: AppWindow,
    { path, raw, encoding }: IPCEvents[IPCEventType.fsRequestWrite]["data"]
  ): Promise<RequestStatus<FsRequestResult<string>>> {
...
export class FsEnsureRegularFileHandler extends IPCHandler<IPCEventType.fsEnsureRegularFile> {
  ...
  public async handle(
    window: AppWindow,
    { path, data, encoding }: IPCEvents[IPCEventType.fsEnsureRegularFile]["data"]
  ): Promise<RequestStatus<FsRequestResult<void>>> {
...
export class FsWriteFileNoFollowHandler extends IPCHandler<IPCEventType.fsWriteFileNoFollow> {
  ...
  public async handle(
    window: AppWindow,
    { path, data, encoding }: IPCEvents[IPCEventType.fsWriteFileNoFollow]["data"]
  ): Promise<RequestStatus<FsRequestResult<void>>> {
    const denied = await ensurePathAllowed<void>(window, path, "write");
    if (denied) return this.success(denied);
...
export class FsRecoverCorruptedJsonFileHandler extends IPCHandler<IPCEventType.fsRecoverCorruptedJsonFile> {
  ...
  public async handle(
    window: AppWindow,
    { path, replacement, encoding }: IPCEvents[IPCEventType.fsRecoverCorruptedJsonFile]["data"]
  ): Promise<RequestStatus<FsRequestResult<void>>> {
    const denied = await ensurePathAllowed<void>(window, path, "write");
    if (denied) return this.success(denied);
...
export class FsCreateDirHandler extends IPCHandler<IPCEventType.fsCreateDir> {
  ...
  public async handle(
    window: AppWindow,
    { path }: IPCEvents[IPCEventType.fsCreateDir]["data"]
  ): Promise<RequestStatus<FsRequestResult<void>>> {
    const denied = await ensurePathAllowed<void>(window, path, "write");
    if (denied) return this.success(denied);
...
export class FsDeleteFileHandler extends IPCHandler<IPCEventType.fsDeleteFile> {
  ...
  public async handle(
    window: AppWindow,
    { path }: IPCEvents[IPCEventType.fsDeleteFile]["data"]
  ): Promise<RequestStatus<FsRequestResult<void>>> {
    const denied = await ensurePathAllowed<void>(window, path, "write");
    if (denied) return this.success(denied);
...
export class FsDeleteDirHandler extends IPCHandler<IPCEventType.fsDeleteDir> {
  ...
  public async handle(
    window: AppWindow,
    { path }: IPCEvents[IPCEventType.fsDeleteDir]["data"]
  ): Promise<RequestStatus<FsRequestResult<void>>> {
    const denied = await ensurePathAllowed<void>(window, path, "write");
    if (denied) return this.success(denied);
...
export class FsRenameHandler extends IPCHandler<IPCEventType.fsRename> {
  ...
  public async handle(
    window: AppWindow,
    { oldPath, newName, isDir }: IPCEvents[IPCEventType.fsRename]["data"]
  ): Promise<RequestStatus<FsRequestResult<void>>> {
...
export class FsCopyFileHandler extends IPCHandler<IPCEventType.fsCopyFile> {
  ...
  public async handle(
    window: AppWindow,
    { src, dest }: IPCEvents[IPCEventType.fsCopyFile]["data"]
  ): Promise<RequestStatus<FsRequestResult<void>>> {
...
export class FsCopyDirHandler extends IPCHandler<IPCEventType.fsCopyDir> {
  ...
  public async handle(
    window: AppWindow,
    { src, dest }: IPCEvents[IPCEventType.fsCopyDir]["data"]
  ): Promise<RequestStatus<FsRequestResult<void>>> {
    const readDenied = await ensurePathAllowed<void>(window, src, "read");
    if (readDenied) return this.success(readDenied);
    const writeDenied = await ensurePathAllowed<void>(window, dest, "write");
...
export class FsMoveFileHandler extends IPCHandler<IPCEventType.fsMoveFile> {
  ...
  public async handle(
    window: AppWindow,
    { src, dest }: IPCEvents[IPCEventType.fsMoveFile]["data"]
  ): Promise<RequestStatus<FsRequestResult<void>>> {
    const readDenied = await ensurePathAllowed<void>(window, src, "read");
    if (readDenied) return this.success(readDenied);
...
export class FsMoveDirHandler extends IPCHandler<IPCEventType.fsMoveDir> {
  ...
  public async handle(
    window: AppWindow,
    { src, dest }: IPCEvents[IPCEventType.fsMoveDir]["data"]
  ): Promise<RequestStatus<FsRequestResult<void>>> {
    const readDenied = await ensurePathAllowed<void>(window, src, "read");
    if (readDenied) return this.success(readDenied);
    const writeDenied = await ensurePathsAllowed<void>(window, "write", src, dest);
...
export class FsFileExistsHandler extends IPCHandler<IPCEventType.fsFileExists> {
  ...
  public async handle(
    window: AppWindow,
    { path }: IPCEvents[IPCEventType.fsFileExists]["data"]
  ): Promise<RequestStatus<FsRequestResult<boolean>>> {
...
export class FsDirExistsHandler extends IPCHandler<IPCEventType.fsDirExists> {
  ...
  public async handle(
    window: AppWindow,
    { path }: IPCEvents[IPCEventType.fsDirExists]["data"]
  ): Promise<RequestStatus<FsRequestResult<boolean>>> {
    const denied = await ensurePathAllowed<boolean>(window, path, "read");
    if (denied) return this.success(denied);
...
export class FsIsFileHandler extends IPCHandler<IPCEventType.fsIsFile> {
  ...
  public async handle(
    window: AppWindow,
    { path }: IPCEvents[IPCEventType.fsIsFile]["data"]
  ): Promise<RequestStatus<FsRequestResult<boolean>>> {
    const denied = await ensurePathAllowed<boolean>(window, path, "read");
    if (denied) return this.success(denied);
...
export class FsIsDirHandler extends IPCHandler<IPCEventType.fsIsDir> {
  ...
  public async handle(
    window: AppWindow,
    { path }: IPCEvents[IPCEventType.fsIsDir]["data"]
  ): Promise<RequestStatus<FsRequestResult<boolean>>> {
    const denied = await ensurePathAllowed<boolean>(window, path, "read");
    if (denied) return this.success(denied);
...
export class FsSelectFileHandler extends IPCHandler<IPCEventType.fsSelectFile> {
  ...
  public async handle(
    window: AppWindow,
    { filters, multiple }: IPCEvents[IPCEventType.fsSelectFile]["data"]
  ): Promise<RequestStatus<FsRequestResult<string[]>>> {
...
export class FsSelectDirectoryHandler extends IPCHandler<IPCEventType.fsSelectDirectory> {
  ...
  public async handle(
    window: AppWindow,
    { multiple }: IPCEvents[IPCEventType.fsSelectDirectory]["data"]
  ): Promise<RequestStatus<FsRequestResult<string[]>>> {
...
export class FsGrantFileAccessHandler extends IPCHandler<IPCEventType.fsGrantFileAccess> {
  ...
  public async handle(
    window: AppWindow,
    { paths }: IPCEvents[IPCEventType.fsGrantFileAccess]["data"]
  ): Promise<RequestStatus<FsRequestResult<string[]>>> {
...
export class FsHashHandler extends IPCHandler<IPCEventType.fsHash> {
  ...
  public async handle(
    window: AppWindow,
    { path }: IPCEvents[IPCEventType.fsHash]["data"]
  ): Promise<RequestStatus<FsRequestResult<string>>> {
    const denied = await ensurePathAllowed<string>(window, path, "read");
    if (denied) return this.success(denied);
