...
import type { PsdWorkerInboundMessage, PsdWorkerOutboundMessage } from "@/buildWorker/psdWorkerProtocol";
...
export function bakePsdLayers(app: PsdWorkerHostApp, request: PsdBakeJob): Promise<PsdBakedLayer[]> {
