      ...
      <main className="min-h-0 flex-1 flex items-center justify-center px-8">
        <section className="w-full max-w-sm text-center">
          ...
          <h1 className="text-base font-semibold text-fg">
            {t("workspace.shell.notAProjectTitle")}
          </h1>
          ...
          {projectPath && (
            <p
              className="nl-selectable-text mt-3 break-all text-xs text-fg-subtle"
              data-tip={projectPath}
            >
              {projectPath}
            </p>
          )}
          <Button variant="secondary" size="md" onClick={handleOpenLauncher} className="mt-6">
