      ...
      <div className="flex flex-col gap-5 text-sm">
        <label className="flex items-center gap-3">
          <span className="w-24 shrink-0 text-fg-muted">
            {t("workspace.shell.background.image")}
          </span>
          <input
            type="text"
            readOnly
        ...
        <label className="flex items-center gap-3">
          <span className="w-24 shrink-0 text-fg-muted">
            {t("workspace.shell.background.opacity")}
          </span>
          <Slider
        ...
        <label className="flex items-center gap-3">
          <span className="w-24 shrink-0 text-fg-muted">
            {t("workspace.shell.background.blur")}
          </span>
          <Slider
            className="min-w-0 flex-1"
            value={current.blur}
        ...
        <div className="flex items-start gap-3">
          <span className="w-24 shrink-0 pt-1.5 text-fg-muted">
            {t("workspace.shell.background.fillMode")}
          </span>
        ...
        <div className="flex items-start gap-3">
          <span className="w-24 shrink-0 pt-1 text-fg-muted">
            {t("workspace.shell.background.anchor")}
          </span>
          <div
