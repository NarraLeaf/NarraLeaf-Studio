    ...
    return (
        ...
        >
            <p
                ...
                title={[headline?.text, headline?.original]
            ...
            {(state.kind === "current" || state.kind === "revision") && face.text && (
                <div className="mt-0.5 text-2xs text-fg-subtle">
                    <span
                        ...
                        title={[face.full, hash].filter((line, index, lines) => lines.indexOf(line) === index).join("\n")}
                    >
                        {face.text}
                    </span>
                </div>
        ...
        <div data-vcs-seam="author-identity" className="mb-2">
            ...
            <div className="mt-1 flex items-center gap-1.5">
                ...
                <button
                    ...
                    title={t("workspace.shell.versionControl.authorSave")}
    ...
    if (editing) {
        return (
            <div data-vcs-seam="server-form" className="border-b border-edge px-3 py-2">
                {/* Asked here too, and this is the place it matters most: a server means the history
                    is about to be shared, and one signed by the tool tells a collaborator nothing.
                    Above the address rather than below it because it is the shorter answer. */}
                <AuthorIdentity surface={surface} />
                ...
                {base && (
                    <div className="mt-1 flex items-center gap-1.5">
                        ...
                        <button
                            ...
                            title={t("workspace.shell.versionControl.compareBase.clear")}
