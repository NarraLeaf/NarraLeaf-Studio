 ...
 */
export function SaveSchemaFieldsModal({
  isOpen,
  onClose
}: {
  isOpen: boolean;
  ...
  const setDefault = useCallback(
    (field: SaveSchemaField, raw: string) => {
      service?.updateField(field.id, {
        defaultValue: parseDefaultValue(field.valueType, raw) as LiteralValue
      });
    },
    [service]
  );
