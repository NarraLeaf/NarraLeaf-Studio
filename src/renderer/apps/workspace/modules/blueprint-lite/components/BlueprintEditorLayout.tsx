...
export function BlueprintEditorLayout({
  ...
  return (
    ...
    <div
      className="flex h-full min-h-0 flex-col bg-surface text-sm text-fg"
      data-help-topic="blueprints"
    >
      ...
      <div className="relative flex min-h-0 min-w-0 flex-1">
        <aside className={leftPanelClasses}>
          <div className="flex shrink-0 items-center justify-between border-b border-edge px-2 py-1.5">
            ...
            <button
              ...
              data-tip={
                isLeftCollapsed
                  ? t("blueprint.sidePanel.expand")
                  : t("blueprint.sidePanel.collapse")
              }
              aria-label={
                isLeftCollapsed
                  ? t("blueprint.sidePanel.expand")
        ...
        {isLeftCollapsed ? (
          <button
            ...
            data-tip={t("blueprint.sidePanel.expand")}
            aria-label={t("blueprint.sidePanel.expand")}
          >
            <ChevronDown className="h-4 w-4" />
          </button>
        ) : null}
