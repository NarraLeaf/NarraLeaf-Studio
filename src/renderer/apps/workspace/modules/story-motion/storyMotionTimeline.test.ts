        ...
        keyframes: [
          {
            id: "kf-position-0",
            timeMs: 0,
            value: { xalign: 0.5, yalign: 0.55, xoffset: -120, yoffset: 0 },
            easing: "linear"
          },
          {
            id: "kf-position-420",
            timeMs: 420,
            value: { xalign: 0.5, yalign: 0.55, xoffset: 0, yoffset: 0 },
            easing: "linear"
          }
        ]
      }
...
describe("storyMotionTimeline", () => {
      ...
      tracks: [
        {
          id: "track-opacity",
          property: "opacity",
          keyframes: [{ id: "kf-200", timeMs: 200, value: 0.25, easing: "easeOut" }]
        }
      ]
    };
  ...
  it("upserts keyframes by property and time", () => {
    ...
    expect(updated.tracks[0].keyframes[0]).toEqual(
  ...
  it("clamps keyframe edits to the 300 second timeline limit", () => {
    ...
    const withKeyframe = upsertStoryMotionKeyframe(
      timeline,
      "rotation",
      STORY_MOTION_MAX_DURATION_MS + 5000,
      8
    );
