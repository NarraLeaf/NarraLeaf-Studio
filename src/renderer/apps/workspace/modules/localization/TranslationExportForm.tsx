...
> = {
  csv: {
    label: "workspace.localization.exchange.formatCsv",
    hint: "workspace.localization.exchange.formatCsvHint"
  },
  xliff: {
    label: "workspace.localization.exchange.formatXliff",
    hint: "workspace.localization.exchange.formatXliffHint"
  },
  po: {
    label: "workspace.localization.exchange.formatPo",
    hint: "workspace.localization.exchange.formatPoHint"
  },
  json: {
    label: "workspace.localization.exchange.formatJson",
    hint: "workspace.localization.exchange.formatJsonHint"
  }
} as const;
...
export function TranslationExportForm({
  ...
  const changeFormat = useCallback(
    (next: TranslationExchangeFormat) => {
      setFormat(next);
      onChange(next, scope);
    },
    [onChange, scope]
  ...
  const scopeOptions: SelectOption[] = [
    ...
    {
      value: "pending",
      label: `${t("workspace.localization.exchange.scopePending")} (${pendingCount})`
    }
  ];
