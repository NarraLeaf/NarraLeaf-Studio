...
export function ProjectSigningSection({
  ...
  const commit = useCallback(
    async (platform: SigningPlatform, credentialId: string | undefined) => {
      if (saving) {
        return;
      }
      ...
      try {
        ...
        const updated = await projectService.updateSigningConfiguration({
  ...
  const removeCredential = useCallback(
    async (credential: SigningCredential) => {
      if (!uiService) {
        return false;
      }
  ...
  return (
    ...
    >
      ...
      <SigningSection
        ...
        signing={signing}
        busy={saving}
        onChange={(platform, credentialId) => {
          void commit(platform, credentialId);
        }}
