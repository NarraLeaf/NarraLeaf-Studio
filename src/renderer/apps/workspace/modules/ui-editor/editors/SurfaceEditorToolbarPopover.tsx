...
export function SurfaceToolbarPopoverSection({
  label,
  children,
  first = false
}: SurfaceToolbarPopoverSectionProps) {
  return (
...
export function SurfaceToolbarPopoverRow({
  ...
  return (
    ...
    >
      ...
      {shortcut ? (
        <span className="ml-auto pl-4 tabular-nums text-2xs text-fg-subtle">{shortcut}</span>
      ) : null}
    </button>
  );
}
