        ...
        <div className="pointer-events-none absolute inset-0 z-[5]">
            {hints.map(hint => {
                ...
                return (
                    ...
                    >
                        <span className="absolute left-0 top-full z-10 mt-0.5 max-w-[240px] truncate rounded-md bg-black/75 px-1 py-0.5 text-2xs leading-tight text-amber-100/95 shadow-sm">
                            {hint.label}
                        </span>
                    </div>
                );
