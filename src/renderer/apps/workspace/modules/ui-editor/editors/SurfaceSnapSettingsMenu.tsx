        ...
        <div className="pt-1">
          <label className="flex cursor-pointer items-center gap-2 px-3 py-1.5 text-xs text-fg hover:bg-fill-subtle">
            <input
              ...
              onChange={() =>
                patch({
                  snapCanvasLayout: !stateService.getSmartSnapDetailSettings().snapCanvasLayout
                })
              }
            />
          ...
          <label className="flex cursor-pointer items-center gap-2 px-3 py-1.5 text-xs text-fg hover:bg-fill-subtle">
            <input
              ...
              onChange={() =>
                patch({
                  snapElementBorder: !stateService.getSmartSnapDetailSettings().snapElementBorder
                })
              }
            />
          ...
          <label className="flex cursor-pointer items-center gap-2 px-3 py-1.5 text-xs text-fg hover:bg-fill-subtle">
            <input
              ...
              onChange={() =>
                patch({
                  snapElementLayout: !stateService.getSmartSnapDetailSettings().snapElementLayout
                })
              }
            />
