...
export const SurfaceOutlinePanel = memo(function SurfaceOutlinePanel({
  ...
  const canShowLayers =
    Boolean(stateService) && Boolean(documentService) && Boolean(localBlueprint);
    ...
    <>
      <div className={panelClasses}>
        <div className="shrink-0 px-3 py-2 border-b border-edge text-xs text-fg-subtle flex items-center justify-between">
          ...
          <button
            ...
            data-tip={
              isCollapsed
                ? t("uiEditor.editor.expandOutline")
                : t("uiEditor.editor.collapseOutline")
            }
            aria-label={
              isCollapsed
                ? t("uiEditor.editor.expandOutline")
          ...
          <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain">
            {canShowLayers ? (
              ...
              <div className="p-4 text-xs text-fg-subtle">
                {t("uiEditor.editor.loadingServices")}
              </div>
            )}
          </div>
        )}
      ...
      {isCollapsed && (
        <button
          ...
          data-tip={t("uiEditor.editor.expandOutline")}
          aria-label={t("uiEditor.editor.expandOutline")}
        >
