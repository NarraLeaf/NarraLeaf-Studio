...
import { SurfaceToolbarPopoverPanel, SurfaceToolbarPopoverRow, useSurfaceToolbarPopover } from "./SurfaceEditorToolbarPopover";
...
const ALIGN_ENTRIES: readonly AlignEntry[] = [
    { op: "left", icon: AlignStartVertical, labelKey: "uiEditor.align.left", catalogId: "ui-editor.align-left" },
    { op: "horizontalCenter", icon: AlignCenterVertical, labelKey: "uiEditor.align.horizontalCenter", catalogId: "ui-editor.align-horizontal-center" },
    { op: "right", icon: AlignEndVertical, labelKey: "uiEditor.align.right", catalogId: "ui-editor.align-right" },
    { op: "top", icon: AlignStartHorizontal, labelKey: "uiEditor.align.top", catalogId: "ui-editor.align-top" },
    { op: "verticalCenter", icon: AlignCenterHorizontal, labelKey: "uiEditor.align.verticalCenter", catalogId: "ui-editor.align-vertical-center" },
    { op: "bottom", icon: AlignEndHorizontal, labelKey: "uiEditor.align.bottom", catalogId: "ui-editor.align-bottom" },
];

const DISTRIBUTE_ENTRIES: readonly AlignEntry[] = [
    { op: "distributeHorizontal", icon: AlignHorizontalDistributeCenter, labelKey: "uiEditor.align.distributeHorizontal", catalogId: "ui-editor.distribute-horizontal" },
    { op: "distributeVertical", icon: AlignVerticalDistributeCenter, labelKey: "uiEditor.align.distributeVertical", catalogId: "ui-editor.distribute-vertical" },
];
