  ...
  return (
    <div className="space-y-4">
      <InputGroup
        label={t("common.name")}
        required
        error={name.trim().length === 0 ? t("uiEditor.createDialog.nameRequired") : undefined}
      >
        <Input
          value={name}
      ...
      <div className="grid grid-cols-2 gap-3">
        <InputGroup
          label={t("uiEditor.createDialog.width")}
          required
          error={widthValue == null ? t("uiEditor.createDialog.positiveIntegerError") : undefined}
        >
          <Input
            type="number"
            min={1}
        ...
        <InputGroup
          label={t("uiEditor.createDialog.height")}
          required
          error={heightValue == null ? t("uiEditor.createDialog.positiveIntegerError") : undefined}
        >
          <Input
            type="number"
            min={1}
