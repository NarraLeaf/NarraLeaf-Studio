...
export function useAssetsContextMenu({
  ...
  const contextMenu: ContextMenuDef = useMemo(() => {
    ...
    const actsOnSelection =
      isMultiSelectMode && contextMenuActsOnSelection(contextMenuTarget, selectedItems);
    ...
    if (
      contextMenuTarget.category === AssetCategory.Other &&
