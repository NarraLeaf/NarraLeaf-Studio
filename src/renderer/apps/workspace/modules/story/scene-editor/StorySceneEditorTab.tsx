            ...
            >
                ...
                {editor.editorMode.kind === "insert" && !editor.editorMode.slot.replaceBlockId && editor.editorMode.slot.afterBlockId === null && !editor.editorMode.slot.target?.beforeBlockId ? (
                    ...
                    <button
                        ...
                        {...freeze.writes()}
                    >
                        {/* Mirrors a row: the "+" stands in the badge column and the words land on the
                            body edge, so the tail of the list does not step out of the one column the
                            whole document reads down. */}
