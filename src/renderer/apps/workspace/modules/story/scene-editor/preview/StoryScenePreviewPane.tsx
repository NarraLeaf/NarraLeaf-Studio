...
export function StoryScenePreviewPane(props: {
  ...
  const busy =
    controller.phase === "compiling" ||
    controller.phase === "mounting" ||
      ...
      >
        ...
        {onToggleFloat ? (
          <button
            ...
            data-tip={mode === "float" ? t("story.preview.dock") : t("story.preview.pip")}
            aria-label={mode === "float" ? t("story.preview.dock") : t("story.preview.pip")}
          >
            {mode === "float" ? (
        ...
        <button
          ...
          onPointerDown={(event) => event.stopPropagation()}
          onClick={onClose}
          data-tip={t("story.preview.closePreview")}
          aria-label={t("story.preview.closePreview")}
        >
        ...
        {controller.phase === "error" ? (
          <div className="absolute inset-0 z-10 flex items-center justify-center bg-black/70 p-4">
            <div className="max-w-full text-center">
              ...
              <div className="mt-1 break-words text-2xs text-white/70">
