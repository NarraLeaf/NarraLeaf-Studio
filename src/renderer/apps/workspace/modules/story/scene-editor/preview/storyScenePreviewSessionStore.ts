...
export function getStoryScenePreviewPaneState(
  panelState: PanelStateService
): StoryScenePreviewPaneState {
  const stored = panelState.getPanelState<Partial<StoryScenePreviewPaneState>>(
    STORY_PREVIEW_PANE_STATE_KEY
  );
  return {
...
export function patchStoryScenePreviewPaneState(
  panelState: PanelStateService,
  patch: Partial<StoryScenePreviewPaneState>
): void {
  panelState.setPanelState<Partial<StoryScenePreviewPaneState>>(
    STORY_PREVIEW_PANE_STATE_KEY,
    patch
  );
}
