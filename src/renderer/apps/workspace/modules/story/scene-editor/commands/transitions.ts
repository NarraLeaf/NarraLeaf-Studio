 ...
 */
function inspectorLabelKey(
  context: StoryTransitionContext,
  word: StoryTransitionWord
): string | null {
  if (word === "none") {
    return "common.none";
  }
...
export function transitionOptions(
  context: StoryTransitionContext
): readonly StoryCommandEnumOption[] {
 ...
 */
export function mergedTransitionOptions(
  ...contexts: readonly StoryTransitionContext[]
): readonly StoryCommandEnumOption[] {
...
const REVEAL_PRESETS: Partial<
  Record<StoryTransitionWord, NonNullable<StoryTransformRef["preset"]>>
> = {
  fade: "fadeIn",
...
export function transitionKindFor(
  ...
  word: string
): StoryTransitionRef["kind"] | undefined {
...
export function transformPresetFor(
  context: "reveal" | "conceal" | "nvl",
  word: string
): StoryTransformRef["preset"] | undefined {
  if (context === "nvl") {
...
function wordFor<T>(
  context: StoryTransitionContext,
  stored: T | undefined,
  of: (word: StoryTransitionWord) => T | undefined
...
export function transitionWordFor(
  context: "scene" | "character",
...
export function transitionWordForPreset(
  context: "reveal" | "conceal" | "nvl",
  preset: StoryTransformRef["preset"] | undefined
): StoryTransitionWord | null {
