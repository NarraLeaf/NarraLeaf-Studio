...
const OPERATION_ORDER: readonly CameraOperation[] = [
  "zoom",
  "pan",
  "rotate",
  "darken",
...
export function CameraActionEditor(props: {
  ...
  const setPan = useCallback(
    (next: { xalign?: number; yalign?: number }) => {
      onChange({
        ...payload,
        position: {
          ...payload.position,
            ...
            return (
              ...
              >
                ...
                <span className="truncate">
                  {t(`storyInspector.cameraOperationShort.${option}`)}
                </span>
              </button>
            );
          })}
