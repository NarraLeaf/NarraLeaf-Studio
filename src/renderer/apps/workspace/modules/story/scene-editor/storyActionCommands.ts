...
export function createBlockForCommand(
  ...
  switch (commandId) {
    case "dialogue":
      return {
        ...
        payload: {
          action: "dialogue",
          characterId,
          text: { textId, role: "dialogue", value: initialText }
        }
      };
    case "choice":
      return {
        ...base,
        kind: "nodeAction",
        payload: { action: "choice", prompt: { textId, role: "choicePrompt", value: initialText } }
      };
    case "choiceOption":
      return {
        ...base,
        ...
        payload: {
          action: "choiceOption",
          text: { textId, role: "choiceText", value: initialText }
        }
      };
    case "condition":
    ...
    case "characterExit":
      return {
        ...
        payload: {
          action: "character",
          operation: "exit",
          transform: { preset: "fadeOut", durationMs: 250 }
        }
      };
    ...
    case "sound":
      return {
        ...base,
        kind: "action",
        payload: { action: "audio", operation: "playSound", objectName: "sound" }
      };
    case "stopSound":
      return {
        ...base,
        kind: "action",
        payload: { action: "audio", operation: "stopSound", objectName: "sound" }
      };
    case "pauseSound":
      return {
        ...base,
        kind: "action",
        payload: { action: "audio", operation: "pauseSound", objectName: "sound" }
      };
    case "resumeSound":
      return {
        ...base,
        kind: "action",
        payload: { action: "audio", operation: "resumeSound", objectName: "sound" }
      };
    case "soundVolume":
      return {
        ...base,
    ...
    case "soundRate":
      return {
        ...base,
        kind: "action",
        payload: { action: "audio", operation: "setRate", objectName: "sound", rate: 1 }
      };
    case "muteSound":
      return {
        ...base,
        kind: "action",
        payload: { action: "audio", operation: "muteSound", objectName: "sound", muted: true }
      };
    case "seekSound":
      return {
        ...base,
        kind: "action",
        payload: { action: "audio", operation: "seekSound", objectName: "sound", timeMs: 0 }
      };
    ...
    case "declareSceneVariable":
      return {
        ...base,
        kind: "declaration",
        payload: { scope: "scene", name: "variable", valueType: "boolean", storageKey: blockId }
      };
    case "executeScript":
    ...
    case "imageSetSource":
      return {
        ...base,
        kind: "action",
        payload: { action: "image", operation: "setSource", objectName: "image" }
      };
    case "imageShow":
      return {
        ...base,
        ...
        payload: {
          ...
          operation: "show",
          objectName: "image",
          transform: { preset: "fadeIn", durationMs: 250 }
        }
      };
    case "imageHide":
      return {
    ...
    case "textFont":
      return {
        ...base,
        kind: "action",
        payload: { action: "text", operation: "setFontSize", objectName: "text", fontSize: 32 }
      };
    case "layerCreate":
      return {
        ...base,
        kind: "action",
        payload: { action: "layer", operation: "create", objectName: "layer", zIndex: 1 }
      };
    case "layerZIndex":
      return {
        ...base,
        ...
        payload: {
          ...
          operation: "setZIndex",
          objectName: "",
          target: { kind: "default", layer: "displayable" },
          zIndex: 1
        }
      };
    case "videoCreate":
      return {
        ...base,
        kind: "action",
        payload: { action: "video", operation: "create", objectName: "video", muted: false }
      };
    case "videoShow":
      return {
        ...base,
        kind: "action",
        payload: { action: "video", operation: "show", objectName: "video" }
      };
    case "videoHide":
      return {
        ...base,
        kind: "action",
        payload: { action: "video", operation: "hide", objectName: "video" }
      };
    case "videoPlay":
      return {
        ...base,
        kind: "action",
        payload: { action: "video", operation: "play", objectName: "video" }
      };
    case "nvl":
      return {
        ...base,
        kind: "action",
        payload: { action: "nvl", transition: { preset: "fadeIn", durationMs: 250 } }
      };
    case "screenBlink":
      return {
        ...base,
    ...
    case "waitDuration":
      return {
        ...base,
        kind: "action",
        payload: { action: "wait", mode: "duration", durationMs: 1000 }
      };
    case "waitClick":
    ...
    case "note":
      return {
        ...base,
        kind: "note",
        payload: { text: { textId, role: "note", value: initialText } }
      };
    case "narration":
    default:
      return {
        ...base,
        kind: "nodeAction",
        payload: { action: "narration", text: { textId, role: "narration", value: initialText } }
      };
  }
}
