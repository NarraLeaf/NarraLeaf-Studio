...
const ROW_CLASS =
  "flex w-full min-w-0 cursor-default items-center gap-1.5 px-2 py-1 text-left text-2xs";
              ...
              >
                ...
                <span className="flex min-w-0 flex-1 flex-col gap-0.5">
                  <span className="flex min-w-0 items-center gap-1">
                    <span className="min-w-0 truncate" data-tip={group.name}>
                      {group.name}
                    </span>
        ...
        <div className="shrink-0 border-t border-edge py-0.5">
          {routeMap.unreachableEndings.length > 0 && (
            ...
            >
              ...
              <span className="min-w-0 flex-1 truncate">
                {tn(
                  "story.flow.route.diagnostics.unreachableEndings",
                  routeMap.unreachableEndings.length
                )}
              </span>
            </button>
          )}
