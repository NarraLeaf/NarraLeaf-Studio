        ...
        <div className="flex min-w-0 items-center gap-1.5">
          {scene.isEntry && (
            <Flag
              ...
              aria-label={t("story.flow.badge.entry")}
            />
          )}
          {/* Sized through the canvas's scale variable so a zoomed-out embed can keep the
                        ...
                        nothing moves. */}
          <span className="truncate font-medium text-fg" style={NODE_TITLE_STYLE}>
            {scene.name}
          </span>
          {canExpand && (
            <button
            ...
            >
              ...
              <span className="tabular-nums" style={NODE_META_STYLE}>
                {armCount}
              </span>
            </button>
          )}
