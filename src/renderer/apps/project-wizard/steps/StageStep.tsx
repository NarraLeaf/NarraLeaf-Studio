 ...
 */
const SCRIPT_LOCALE_SUGGESTIONS = [
  "en",
  "zh",
  "zh-TW",
  "ja",
...
export function StageStep({ projectData, updateProjectData, templateStageSizes }: StageStepProps) {
  ...
  const matchesOffered =
    selected !== null && offered.some((size) => stageSizesEqual(size, selected));
  ...
  const orientationHint = selected
    ? t(
        stageOrientation(selected) === "portrait"
    ...
    <div className="h-full overflow-y-auto p-5">
      <div className="max-w-xl space-y-4">
        ...
        <InputGroup
          ...
          helper={t("wizard.stage.scriptLocaleHelper")}
        >
          <Select
