...
import { Accordion, AccordionItem, Input, InputGroup, Select, TextArea } from "@/lib/components/elements";
import { getInterface } from "@/lib/app/bridge";
import type { VcsAvailability } from "@shared/types/vcs";
import { versionControlOptions } from "../constants";
import { ProjectData, DirectoryValidationResult, ValidationErrors, VersionControlChoice } from "../types";
            ...
            <div className="max-w-xl space-y-4">
                ...
                >
                    <Select
                        ...
                        onChange={value => updateProjectData({ versionControl: value as VersionControlChoice })}
                        fullWidth
                ...
                <Accordion className="pt-1">
                    <AccordionItem id="more" title={t("wizard.project.moreDetails")}>
                        <div className="space-y-4 pb-1 pt-2">
                            <InputGroup label={t("wizard.fields.version")} helper={t("wizard.project.versionHelper")}>
                                <Input
                                    placeholder="1.0.0"
