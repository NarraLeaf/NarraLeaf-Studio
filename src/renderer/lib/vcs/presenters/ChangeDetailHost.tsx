...
// claims a document (see `registry.ts`). Nothing here overlaps - three of them read a content
// class the comparison settled and the fourth reads a document kind - so the order below is
