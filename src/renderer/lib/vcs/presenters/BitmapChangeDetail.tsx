...
function Frame({ side, box, caption }: { side: BitmapSide; box: PixelSize; caption: TranslationKey | null }) {
    const { t } = useTranslation();
    return (
            ...
            >
                ...
                <div
                    ...
                    onKeyDown={event => {
                        ...
                        setSplit(current => (step === "min" ? 0 : step === "max" ? 100 : clamp(current + step)));
                    }}
 ...
 */
function Difference({ before, after, box }: { before: BitmapSide; after: BitmapSide; box: PixelSize }) {
    const { t } = useTranslation();
    return (
        <figure className="flex flex-col gap-1">
