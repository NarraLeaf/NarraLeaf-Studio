  ...
  return {
    fs: {
      ...
      createDir: (path: string): Promise<RequestStatus<FsRequestResult<void>>> =>
        refuseFrozenWrite(path) ? frozenNoOp() : privileged().fs.createDir(actor(), path),
      deleteFile: (path: string): Promise<RequestStatus<FsRequestResult<void>>> =>
        refuseFrozenWrite(path) ? frozenNoOp() : privileged().fs.deleteFile(actor(), path),
      deleteDir: (path: string): Promise<RequestStatus<FsRequestResult<void>>> =>
        refuseFrozenWrite(path) ? frozenNoOp() : privileged().fs.deleteDir(actor(), path),
      ...
      copyFile: (src: string, dest: string): Promise<RequestStatus<FsRequestResult<void>>> =>
        refuseFrozenWrite(dest) ? frozenNoOp() : privileged().fs.copyFile(actor(), src, dest),
      copyDir: (src: string, dest: string): Promise<RequestStatus<FsRequestResult<void>>> =>
        refuseFrozenWrite(dest) ? frozenNoOp() : privileged().fs.copyDir(actor(), src, dest),
      moveFile: (src: string, dest: string): Promise<RequestStatus<FsRequestResult<void>>> =>
        refuseFrozenWrite(src, dest) ? frozenNoOp() : privileged().fs.moveFile(actor(), src, dest),
      moveDir: (src: string, dest: string): Promise<RequestStatus<FsRequestResult<void>>> =>
        refuseFrozenWrite(src, dest) ? frozenNoOp() : privileged().fs.moveDir(actor(), src, dest),
