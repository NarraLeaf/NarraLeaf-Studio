...
function commitButtonLabelEditValue(
...
export function ButtonRenderer(props: WidgetRendererProps) {
  ...
  const appearanceTransitions = resolveButtonAppearanceTransitions(
  ...
  const labelTextShadowTransition = firstTransitionForKeys(appearanceTransitions, [
    "effectTextShadow"
  ]);
