...
function ContainerEmptyChildrenHintField(_props: CustomFieldProps<UIInspectorData>) {
  return null;
}
          ...
          options: [
            {
              ...
              label: t("widgets.container.verticalStack")
            },
            {
              id: "horizontal",
              icon: <Columns2 className="w-4 h-4" />,
              label: t("widgets.container.horizontalStack")
            }
          ],
        ...
        defineField<D, any>({
          ...
          options: [
            ...
            },
            {
              ...
              label: t("widgets.container.spaceBetween")
            },
            {
              id: "space-around",
              icon: <AlignVerticalSpaceAround className="w-4 h-4" />,
              label: t("widgets.container.spaceAround")
            }
          ],
