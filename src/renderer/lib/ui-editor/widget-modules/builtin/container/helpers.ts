...
export function getContainerProps(element: UIElement): ContainerWidgetProps {
  ...
  return {
    ...
    stackPaddingTop: clampContainerStackSpacingPx(
      finiteOr(base.stackPaddingTop, merged.stackPaddingTop)
    ),
    stackPaddingRight: clampContainerStackSpacingPx(
      finiteOr(base.stackPaddingRight, merged.stackPaddingRight)
    ),
    stackPaddingBottom: clampContainerStackSpacingPx(
      finiteOr(base.stackPaddingBottom, merged.stackPaddingBottom)
    ),
    stackPaddingLeft: clampContainerStackSpacingPx(
      finiteOr(base.stackPaddingLeft, merged.stackPaddingLeft)
    )
  };
}
