  ...
  return (
    <div className="grid grid-cols-2 gap-2 min-w-0">
      <div className="min-w-0">
        <span className="text-2xs font-medium text-fg-subtle block mb-0.5">
          {t("widgetChrome.effects.shadowOffsetX")}
        </span>
      ...
      <div className="min-w-0">
        <span className="text-2xs font-medium text-fg-subtle block mb-0.5">
          {t("widgetChrome.effects.shadowOffsetY")}
        </span>
        <NumericDraftEnhancedInput
          popoverZIndex={EFFECTS_DETAIL_NUMERIC_POPOVER_Z_INDEX}
      ...
      <div className="min-w-0">
        <span className="text-2xs font-medium text-fg-subtle block mb-0.5">
          {t("widgetChrome.effects.shadowBlur")}
        </span>
        <NumericDraftEnhancedInput
          popoverZIndex={EFFECTS_DETAIL_NUMERIC_POPOVER_Z_INDEX}
      ...
      <div className="min-w-0">
        <span className="text-2xs font-medium text-fg-subtle block mb-0.5">
          {t("widgetChrome.effects.shadowSpread")}
        </span>
        <NumericDraftEnhancedInput
          popoverZIndex={EFFECTS_DETAIL_NUMERIC_POPOVER_Z_INDEX}
...
function EffectsAnchoredPanel({
  ...
  return createPortal(
    ...
    >
      <div className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-visible space-y-2">
        {children}
      </div>
    </div>,
    document.body
  ...
  return (
    <div ref={rootRef} className="flex flex-col gap-2 min-w-0">
      ...
      {enabled.map((kind) => (
        <div
          key={kind}
          className="flex flex-col gap-0 min-w-0 rounded-md border border-edge bg-fill-subtle px-2 py-1.5"
        >
