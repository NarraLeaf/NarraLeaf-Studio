...
export type BlueprintValueFieldConfig = {
  ...
  renderLiteralEditor?: (input: { data: UIInspectorData; liveElement: UIElement }) => ReactNode;
};
      ...
      return (
        <div className="space-y-2">
          <div className="rounded-md border border-edge bg-surface px-3 py-2">
            <div className="flex min-w-0 items-center gap-2">
              ...
              <InspectOnlyButton
                ...
                onContextMenu={blueprintEntryContextMenu((options) =>
          ...
          <button
            ...
            onClick={() =>
              props.data.documentService.clearElementBlueprintValueBinding(live.id, config.propPath)
            }
          >
    ...
    return (
      <div className="space-y-2">
        {config.renderLiteralEditor?.({ data: props.data, liveElement: live }) ?? (
          <div className="rounded-md border border-edge bg-surface px-3 py-2">
            <div className="flex min-w-0 items-center gap-2">
              ...
              <div className="min-w-0 flex-1">
                <div className="truncate text-xs font-medium text-fg">{t(config.title)}</div>
                <div className="truncate font-mono text-2xs text-fg-subtle">
                  {config.valueLabel}
                </div>
              </div>
        ...
        <button
          ...
          data-tip={
            isComponentEditorSurface ? t("widgetChrome.blueprint.componentsUnavailable") : undefined
          }
        >
