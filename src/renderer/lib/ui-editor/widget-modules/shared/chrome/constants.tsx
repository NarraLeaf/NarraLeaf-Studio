...
export const BORDER_STYLE_OPTIONS: { value: string; labelKey: TranslationKey; icon: ReactNode }[] =
  [
    {
      value: "solid",
      labelKey: "widgetAppearance.border.styleSolid",
      icon: <StrokeStyleIcon style="solid" />
    },
    {
      value: "dashed",
      labelKey: "widgetAppearance.border.styleDashed",
      icon: <StrokeStyleIcon style="dashed" />
    },
    {
      value: "dotted",
      labelKey: "widgetAppearance.border.styleDotted",
      icon: <StrokeStyleIcon style="dotted" />
    },
    {
      value: "none",
      labelKey: "widgetAppearance.border.styleNone",
      icon: <StrokeStyleIcon style="none" />
    }
  ];
...
export const STROKE_SIDE_OPTIONS: { id: string; icon: ReactNode; labelKey: TranslationKey }[] = [
  ...
  {
    id: "right",
    icon: <StrokeSideIcon side="right" />,
    labelKey: "widgetAppearance.border.sideRight"
  },
  {
    id: "bottom",
    icon: <StrokeSideIcon side="bottom" />,
    labelKey: "widgetAppearance.border.sideBottom"
  },
