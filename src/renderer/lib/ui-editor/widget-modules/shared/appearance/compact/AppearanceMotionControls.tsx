...
import {
  formatStorySecondsValue,
  storyMsToSeconds,
  storySecondsToMs
} from "@shared/utils/storyTime";
...
function patchTransition(
  ...
  const base =
    nextType === "spring"
      ? getDefaultAppearanceTransition("spring")
      : getDefaultAppearanceTransition("tween");
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                {transition ? (
                  <button
                    ...
                    data-tip={t("widgetAppearance.motion.clearFieldTitle")}
                    aria-label={t("widgetAppearance.motion.clearFieldTitle")}
                  >
