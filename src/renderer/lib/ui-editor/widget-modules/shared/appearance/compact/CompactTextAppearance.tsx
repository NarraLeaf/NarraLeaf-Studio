...
import { Baseline, Droplets, Italic, Move, Type } from "lucide-react";
import type {
...
export function CompactTextAppearance({
  ...
  const fontStyle = readString(
    getTypography("fontStyle"),
    "normal"
  ) as TextWidgetProps["fontStyle"];
  const fontWeight = readString(
    getTypography("fontWeight"),
    "normal"
  ) as TextWidgetProps["fontWeight"];
      ...
      >
        ...
        <div className="flex flex-wrap gap-2 min-w-0">
          ...
          <button
            ...
            onClick={() =>
              patchTypography("fontStyle", fontStyle === "italic" ? "normal" : "italic")
            }
          >
