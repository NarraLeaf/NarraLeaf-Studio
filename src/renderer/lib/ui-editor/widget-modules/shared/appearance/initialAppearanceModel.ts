 ...
 */
export function ensureButtonAppearanceHasAllKeys(
  model: AppearanceModel,
  flat: ButtonWidgetProps
): AppearanceModel {
  let changed = false;
 ...
 */
export function ensureContainerAppearanceHasAllKeys(
  model: AppearanceModel,
  flat: ContainerWidgetProps
): AppearanceModel {
  let changed = false;
  const variants = model.variants.map((v) => {
    const have = new Set(v.propertyGroups.map((g) => g.key));
 ...
 */
export function ensureTextAppearanceHasAllKeys(
  model: AppearanceModel,
  flat: TextWidgetProps
): AppearanceModel {
  let changed = false;
  const variants = model.variants.map((v) => {
    const have = new Set(v.propertyGroups.map((g) => g.key));
 ...
 */
export function ensureImageAppearanceHasAllKeys(
  model: AppearanceModel,
  element: UIElement
): AppearanceModel {
...
function appearanceImageFillRowIsUnconditional(
 ...
 */
export function syncImageAppearanceImageFillFromProps(
  model: AppearanceModel,
  nextFill: ImageFill
): AppearanceModel {
  let changed = false;
...
export function createInitialImageAppearanceFromProps(
  props: Record<string, unknown>
): AppearanceModel {
  return createInitialImageAppearance(getRectangleLikeProps({ props }));
}

export function isUsableAppearanceModel(
