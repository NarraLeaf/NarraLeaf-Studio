...
describe("BlueprintDispatcher", () => {
                ...
                init: {
                  ...
                  graph: {
                    ...
                    edges: [
                      ...
                      {
                        from: { nodeId: "message", port: "value" },
                        to: { nodeId: "log", port: "value" }
                      }
                    ]
                  }
                }
                ...
                keyDown: {
                  ...
                  graph: {
                    ...
                    edges: [
                      {
                        from: { nodeId: "head", port: "then" },
                        to: { nodeId: "setKey", port: "in" }
                      },
                      {
                        from: { nodeId: "head", port: "key" },
                        to: { nodeId: "setKey", port: "value" }
                      }
                    ]
                  }
                }
              ...
              events: {
                ...
                gameReady: {
                  ...
                  graph: {
                    ...
                    edges: [
                      {
                        from: { nodeId: "headReady", port: "then" },
                        to: { nodeId: "setReady", port: "in" }
                      }
                    ]
                  }
                }
                ...
                surfaceInit: {
                  ...
                  graph: {
                    ...
                    edges: [
                      {
                        from: { nodeId: "head", port: "then" },
                        to: { nodeId: "setInitialized", port: "in" }
                      }
                    ]
                  }
                }
                ...
                mouseClick: {
                  ...
                  graph: {
                    ...
                    edges: [
                      ...
                      {
                        from: { nodeId: "setX", port: "next" },
                        to: { nodeId: "setY", port: "in" }
                      },
                      {
                        from: { nodeId: "head", port: "x" },
                        to: { nodeId: "setX", port: "value" }
                      },
                  ...
                  surfaceInit: {
                    ...
                    graph: {
                      ...
                      edges: [
                        ...
                        {
                          from: { nodeId: "delay", port: "completed" },
                          to: { nodeId: "setInitialized", port: "in" }
                        }
                      ]
                    }
  ...
  it("filters On Key event heads case-insensitively", async () => {
    ...
    let locals = acquireBlueprintExecutionLocals({
      blueprintDocument,
    ...
    locals = acquireBlueprintExecutionLocals({
      blueprintDocument,
      currentBlueprintId: blueprintId
    });
                ...
                pageEvent: {
                  ...
                  graph: {
                    ...
                    edges: [
                      {
                        from: { nodeId: "head", port: "then" },
                        to: { nodeId: "setEvent", port: "in" }
                      },
                      {
                        from: { nodeId: "head", port: "event" },
                        to: { nodeId: "setEvent", port: "value" }
                      },
                      {
                        from: { nodeId: "setEvent", port: "next" },
...
describe("invokeBlueprintFnCall", () => {
  function fnEchoGraph(headId: string, withDelay?: boolean) {
    ...
    const edges = [
      {
        from: { nodeId: headId, port: "param_1_value" },
        to: { nodeId: "ret", port: "ret_1_value" }
      }
    ];
    if (withDelay) {
...
describe("ambient window event dispatch", () => {
  ...
  function fullscreenWidgetDocuments(): {
