...
import { isValidBlueprintExecConnection as isValidBlueprintPinConnectionInner } from "../blueprint-nodes/connectionPolicy";
import type {
...
export function getBlueprintNodeEditorCatalogEntry(
  type: string
): BlueprintNodeEditorCatalogEntry | undefined {
  return catalog().getBlueprintNodeEditorCatalogEntry(type);
}

export function listBlueprintNodePaletteEntries(
...
export function resolveBlueprintNodeEditorCatalogEntry(
  type: string
): BlueprintNodeEditorCatalogEntry {
