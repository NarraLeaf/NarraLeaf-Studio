...
} from "../behavior-graph/BehaviorNodeRegistry";
 ...
 */
export const BLUEPRINT_PIN_INLINE_LITERAL_VALUE_TYPES = [
  "string",
  "integer",
  "float",
  "boolean"
...
export type BlueprintPinInlineLiteralValueType =
  (typeof BLUEPRINT_PIN_INLINE_LITERAL_VALUE_TYPES)[number];
...
export const BLUEPRINT_NODE_PARAM_SHOW_MAGIC_ELEMENT_TARGET_PIN =
  "__showMagicElementTargetPin" as const;
/** Persisted on Animate Property nodes when the user explicitly edits the optional From field. */
export const BLUEPRINT_NODE_PARAM_DISPLAYABLE_ANIMATION_FROM_EXPLICIT =
  "__displayableAnimationFromExplicit" as const;
