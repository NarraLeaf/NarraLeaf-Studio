...
export const dataBlueprintNodes: BlueprintNodeDef[] = [
  ...
  dataNode({
    ...
    pins: [jsonIn("json", "JSON"), stringIn("path", "Path"), out("result", "Value", "json")]
  }),
  dataNode({
    type: BLUEPRINT_NODE_TYPE_DATA_JSON_HAS,
    displayName: "Has JSON Field",
    keywords: ["json", "field", "path", "dot", "has", "exists"],
    pins: [jsonIn("json", "JSON"), stringIn("path", "Path"), out("result", "Exists", "boolean")]
  }),
  dataNode({
  ...
  dataNode({
    ...
    pins: [jsonIn("json", "JSON"), stringIn("path", "Path"), out("result", "JSON", "json")]
  }),
  dataNode({
