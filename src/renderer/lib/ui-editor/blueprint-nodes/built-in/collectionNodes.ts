...
const arrayIn = (id: string, label: string): BlueprintNodePinDef =>
  inPin(id, label, BLUEPRINT_VALUE_TYPE_ARRAY);
...
const stringIn = (id: string, label: string): BlueprintNodePinDef =>
  inPin(id, label, "string", true);
const arrayOut = (id: string, label: string): BlueprintNodePinDef =>
  outPin(id, label, BLUEPRINT_VALUE_TYPE_ARRAY);
...
export const collectionBlueprintNodes: BlueprintNodeDef[] = [
  ...
  collectionNode({
    ...
    pins: [
      arrayIn("array", "Array"),
      anyIn("item", "Item"),
      outPin("result", "Contains", "boolean")
    ]
  }),
  collectionNode({
  ...
  collectionNode({
    ...
    pins: [
      arrayIn("array", "Array"),
      stringIn("separator", "Separator"),
      outPin("result", "Text", "string")
    ]
  }),
  collectionNode({
  ...
  collectionNode({
    ...
    pins: [
      jsonIn("object", "Object"),
      stringIn("field", "Field"),
      anyIn("value", "Value"),
      jsonOut("result", "Object")
    ]
  }),
  collectionNode({
