...
const GAME_PREFERENCE_OUTPUT_KEYS: Record<string, { portId: string; key: string }> = {
    ...
    [BLUEPRINT_NODE_TYPE_GAME_GET_MUTE_ON_WINDOW_BLUR]: { portId: "muteOnWindowBlur", key: "muteOnWindowBlur" },
...
function resolveSelfOutput(
    ...
    if (
        (selfNode.type === BLUEPRINT_NODE_TYPE_FLOW_FOR_LOOP ||
            ...
            // Voice getters and the two play nodes, all latent, all publishing onto `value`.
            ...
            selfNode.type === BLUEPRINT_NODE_TYPE_VOICE_PLAY_CHOICE) &&
        (portId === "index" ||
            portId === "item" ||
            portId === "value" ||
            portId === "ids" ||
