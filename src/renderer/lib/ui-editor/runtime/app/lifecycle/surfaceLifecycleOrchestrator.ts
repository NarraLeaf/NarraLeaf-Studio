import {
  SurfaceLifecycleManager,
  type SurfaceResetPolicy
} from "@/lib/ui-editor/blueprint-runtime/SurfaceLifecycleManager";
...
export type LifecycleCommand =
  ...
  | {
      kind: "bumpLifecycleSignal";
      scopeId: string;
      signal: "beforeSurfaceExit" | "afterSurfaceEnter";
    }
