...
export function timelineToNlrTransformSequences(
  timeline: StoryAnimationTimeline
): { props: Record<string, unknown>; options: Record<string, unknown> }[] {
...
function keyframeToTransformProps(
...
export function toNlrTransformSequence(sequence: StoryAnimationSequence): {
  props: Record<string, unknown>;
  options: Record<string, unknown>;
} {
  return {
...
export function cleanTransformSequenceProps(
...
export function cleanTransformSequenceOptions(
...
export function injectVisibilityDefault(
...
export {
  normalizeStageObjectName as normalizeObjectName,
  characterStageObjectName as getCharacterStageObjectName,
  characterStageName
} from "@shared/types/story";
...
export function optionalNumberProp(
  props: Record<string, StoryLiteralValue>,
  key: string
): number | undefined {
