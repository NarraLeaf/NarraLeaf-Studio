...
export function EnhancedInput({
  ...
  const shouldUsePopover =
    popoverWhenNarrow && containerWidth !== null && containerWidth < popoverThreshold;
  ...
  const useNumericChrome =
    rest.type === "number" || rest.inputMode === "numeric" || rest.inputMode === "decimal";
  ...
  return (
    <div ref={setContainerElement} className={rootClassName}>
      {leftIcon && (
        <span className="absolute left-2 text-fg-muted pointer-events-none flex items-center">
          {leftIcon}
        </span>
