...
const inputBase =
  "w-full bg-fill-subtle border rounded-md text-fg placeholder-fg-subtle " +
...
export function Input({
  ...
  return (
    <div className={cn("relative", fullWidth && "w-full")}>
      ...
      {rightIcon && (
        <div
          className={cn("absolute inset-y-0 right-0 flex items-center", rightIconInsetStyles[size])}
        >
          <button
            type="button"
