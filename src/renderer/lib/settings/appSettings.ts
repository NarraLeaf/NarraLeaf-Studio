...
import { ZOOM_PERCENT_DEFAULT, ZOOM_PERCENT_MAX, ZOOM_PERCENT_MIN } from "@shared/constants/zoom";
...
export const AppSettings: AppSettingDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Asks GitHub once, shortly after Studio starts. Downloads never begin on their own.",
  ...
  },
  {
    ...
    description:
      "Turn off animated transitions in the Studio interface. Your game's own animations are unaffected.",
  ...
  },
  {
    ...
    description:
      "Give one kind of row a background tint, so it separates from the rest at a glance.",
