...
const settingsIndex = sortedCategories.reduce<
  Record<AppSettingCategoryKey, AppSettingDefinition[]>
>(
  (acc, category) => {
...
export function getSettingByKey(
  key: AppSettingDefinition["key"]
): AppSettingDefinition | undefined {
