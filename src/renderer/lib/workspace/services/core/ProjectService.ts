...
export class ProjectService extends Service<ProjectService> implements IProjectService {
  ...
  protected async init(
    ...
    if (!configFileName) {
      throw new RendererError(
        "Project config not found: no .nlproj or project.json in project root"
      );
    }
   ...
   */
  public async updateNetworkConfiguration(
    patch: Partial<NetworkConfiguration>
  ): Promise<ProjectConfig> {
    return this.updateProjectConfig((config) => {
   ...
   */
  public async updateCrashConfiguration(
    patch: Partial<CrashConfiguration>
  ): Promise<ProjectConfig> {
    return this.updateProjectConfig((config) => {
   ...
   */
  public async updateSecurityConfiguration(
    patch: Partial<SecurityConfiguration>
  ): Promise<ProjectConfig> {
    return this.updateProjectConfig((config) => {
   ...
   */
  public async updateLintingConfiguration(
    patch: Partial<LintingConfiguration>
  ): Promise<ProjectConfig> {
    return this.updateProjectConfig((config) => {
   ...
   */
  public async updateSigningConfiguration(
    patch: Partial<SigningConfiguration>
  ): Promise<ProjectConfig> {
    return this.updateProjectConfig((config) => {
   ...
   */
  public async updateMobileConfiguration(
    patch: Partial<MobileConfiguration>
  ): Promise<ProjectConfig> {
    return this.updateProjectConfig((config) => {
   ...
   */
  public async updateAutoSaveConfiguration(
  ...
  public async updateProjectIconSet(
    updater: (set: ProjectIconSet) => ProjectIconSet
  ): Promise<ProjectIconSet> {
  ...
  public async importProjectIconSource(
    ...
    throwException(
      await filesystemService.createDir(
    ...
    throwException(
      await filesystemService.writeRaw(this.getContext().project.resolve(relativeSegments), bytes)
    );
  ...
  public async projectIconFileExists(relativePath: string): Promise<boolean> {
    ...
    const exists = await filesystemService.isFileExists(
      this.getContext().project.resolve(relativePath)
    );
  ...
  private async removeIconSourceSiblings(slot: string, keepExtension: string): Promise<void> {
    for (const extension of PROJECT_ICON_PICKER_EXTENSIONS) {
      ...
      await this.deleteProjectIconFile(
        ProjectNameConvention.ProjectIconSource(slot, extension).join("/")
      );
    }
  }
   ...
   */
  public async setDependencyTable(
    table: ProjectDependencyTable | undefined
  ): Promise<ProjectConfig> {
    return this.updateProjectConfig((config) => {
      const next = { ...config };
  ...
  private async readProjectConfigFile(): Promise<ProjectConfig> {
    ...
    if (this.projectConfigFormat === "nlproj") {
      ...
      projectConfig = throwException(
        await filesystemService.readJSON<ProjectConfig>(this.projectConfigPath)
      );
    }
