...
// Re-exported so the many `import { formatKeybinding } from ".../KeybindingService"` call sites keep
// working; the implementation lives apart so display-only surfaces can take it without the service.
export { formatKeybinding } from "./keybindingFormat";
