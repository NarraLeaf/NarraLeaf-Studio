...
import { Notification, NotificationType, NotificationSeverity, NotificationAction } from "./types";
...
export class NotificationService {
  ...
  public async startPersistence(serviceAssets: ServiceAssetsService): Promise<void> {
    ...
    try {
      const stored =
        await serviceAssets.readStore<NotificationHistoryStore>(HISTORY_STORE_NAMESPACE);
