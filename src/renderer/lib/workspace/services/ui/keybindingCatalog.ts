...
export const KEYBINDING_CATALOG: readonly KeybindingCatalogEntry[] = [
    // --- Workspace-wide -----------------------------------------------------
    entry("workspace-command-palette", "mod+shift+p", "workspace.shell.keybindings.catalog.commandPalette", CATEGORY.general, Command),
    entry("workspace-quick-open", "mod+p", "workspace.shell.keybindings.catalog.quickOpen", CATEGORY.general, Search),
    entry("workspace-keybinding-cheatsheet", "shift+?", "workspace.shell.keybindings.catalog.cheatSheet", CATEGORY.general, Keyboard),
    ...
    entry("workspace.redo", "mod+shift+z", "workspace.shell.keybindings.catalog.redo", CATEGORY.general, Redo2),
    entry("workspace-editor-quick-switch-next", "ctrl+tab", "workspace.shell.keybindings.catalog.quickSwitchNext", CATEGORY.general, ArrowRight),
    ...
    entry("story.close-inspector", "escape", "story.keybindings.closeInspector", CATEGORY.story, PanelRightClose),
    ...
    entry("story.insert-blank-after-selection", "shift+enter", "story.keybindings.insertRow", CATEGORY.story, Plus),
    entry("story.delete", "delete", "story.keybindings.deleteRows", CATEGORY.story, Trash2),
    entry("story.backspace", "backspace", "story.keybindings.deleteRowsConfirm", CATEGORY.story, Trash2),
    ...
    entry("story.select-all", "mod+a", "story.keybindings.selectAll", CATEGORY.story, SquareDashedMousePointer),
    ...
    entry("story.move-selection-down", "arrowdown", "story.keybindings.moveSelectionDown", CATEGORY.story, ArrowDown),
    entry("story.move-selection-up", "arrowup", "story.keybindings.moveSelectionUp", CATEGORY.story, ArrowUp),
    entry("story.extend-selection-down", "shift+arrowdown", "story.keybindings.extendSelectionDown", CATEGORY.story, ChevronDown),
    entry("story.extend-selection-up", "shift+arrowup", "story.keybindings.extendSelectionUp", CATEGORY.story, ChevronUp),
    entry("story.move-row-down", "alt+arrowdown", "story.keybindings.moveRowDown", CATEGORY.story, MoveDown),
    entry("story.move-row-up", "alt+arrowup", "story.keybindings.moveRowUp", CATEGORY.story, MoveUp),
    entry("story.select-first", "home", "story.keybindings.selectFirst", CATEGORY.story, ArrowUpToLine),
    entry("story.select-last", "end", "story.keybindings.selectLast", CATEGORY.story, ArrowDownToLine),
    entry("story.select-first-mod", "mod+home", "story.keybindings.selectFirst", CATEGORY.story, ArrowUpToLine),
    entry("story.select-last-mod", "mod+end", "story.keybindings.selectLast", CATEGORY.story, ArrowDownToLine),

    // --- UI editor ----------------------------------------------------------
    entry("ui-editor.undo", "mod+z", "workspace.shell.keybindings.catalog.uiEditor.undo", CATEGORY.uiEditor, Undo2),
    entry("ui-editor.redo", "mod+shift+z", "workspace.shell.keybindings.catalog.uiEditor.redo", CATEGORY.uiEditor, Redo2),
    entry("ui-editor.copy", "mod+c", "workspace.shell.keybindings.catalog.uiEditor.copy", CATEGORY.uiEditor, Copy),
    entry("ui-editor.cut", "mod+x", "workspace.shell.keybindings.catalog.uiEditor.cut", CATEGORY.uiEditor, Scissors),
    entry("ui-editor.paste", "mod+v", "workspace.shell.keybindings.catalog.uiEditor.paste", CATEGORY.uiEditor, ClipboardPaste),
    entry("ui-editor.dup", "mod+d", "workspace.shell.keybindings.catalog.uiEditor.duplicate", CATEGORY.uiEditor, CopyPlus),
    entry("ui-editor.group", "mod+g", "workspace.shell.keybindings.catalog.uiEditor.group", CATEGORY.uiEditor, Group),
    entry("ui-editor.ungroup", "mod+shift+g", "workspace.shell.keybindings.catalog.uiEditor.ungroup", CATEGORY.uiEditor, Ungroup),
    entry("ui-editor.selall", "mod+a", "workspace.shell.keybindings.catalog.uiEditor.selectAll", CATEGORY.uiEditor, SquareDashedMousePointer),
    entry("ui-editor.delete", "delete", "workspace.shell.keybindings.catalog.uiEditor.delete", CATEGORY.uiEditor, Trash2),
    entry("ui-editor.backspace", "backspace", "workspace.shell.keybindings.catalog.uiEditor.delete", CATEGORY.uiEditor, Trash2),
    entry("ui-editor.f2", "f2", "workspace.shell.keybindings.catalog.uiEditor.rename", CATEGORY.uiEditor, PenLine),
    entry("ui-editor.escape", "escape", "workspace.shell.keybindings.catalog.uiEditor.escape", CATEGORY.uiEditor, X),
    ...
    entry("ui-editor.align-left", "alt+a", "workspace.shell.keybindings.catalog.uiEditor.alignLeft", CATEGORY.uiEditor, AlignStartVertical),
    entry("ui-editor.align-horizontal-center", "alt+h", "workspace.shell.keybindings.catalog.uiEditor.alignHorizontalCenter", CATEGORY.uiEditor, AlignCenterVertical),
    entry("ui-editor.align-right", "alt+d", "workspace.shell.keybindings.catalog.uiEditor.alignRight", CATEGORY.uiEditor, AlignEndVertical),
    entry("ui-editor.align-top", "alt+w", "workspace.shell.keybindings.catalog.uiEditor.alignTop", CATEGORY.uiEditor, AlignStartHorizontal),
    entry("ui-editor.align-vertical-center", "alt+v", "workspace.shell.keybindings.catalog.uiEditor.alignVerticalCenter", CATEGORY.uiEditor, AlignCenterHorizontal),
    ...
    entry("blueprint.redo", "mod+shift+z", "workspace.shell.keybindings.catalog.blueprint.redo", CATEGORY.blueprint, Redo2),
    entry("blueprint.copy", "mod+c", "workspace.shell.keybindings.catalog.blueprint.copy", CATEGORY.blueprint, Copy),
    entry("blueprint.cut", "mod+x", "workspace.shell.keybindings.catalog.blueprint.cut", CATEGORY.blueprint, Scissors),
    entry("blueprint.paste", "mod+v", "workspace.shell.keybindings.catalog.blueprint.paste", CATEGORY.blueprint, ClipboardPaste),

    // --- Story motion editor -------------------------------------------------
    entry("story-motion.undo", "mod+z", "workspace.shell.keybindings.catalog.storyMotion.undo", CATEGORY.storyMotion, Undo2),
    entry("story-motion.redo", "mod+shift+z", "workspace.shell.keybindings.catalog.storyMotion.redo", CATEGORY.storyMotion, Redo2),
    entry("story-motion.delete", "delete", "workspace.shell.keybindings.catalog.storyMotion.delete", CATEGORY.storyMotion, Trash2),
    entry("story-motion.backspace", "backspace", "workspace.shell.keybindings.catalog.storyMotion.delete", CATEGORY.storyMotion, Trash2),
    ...
    entry("story-motion.prev-frame", "arrowleft", "workspace.shell.keybindings.catalog.storyMotion.prevFrame", CATEGORY.storyMotion, ChevronLeft),
    entry("story-motion.next-frame", "arrowright", "workspace.shell.keybindings.catalog.storyMotion.nextFrame", CATEGORY.storyMotion, ChevronRight),
    entry("story-motion.prev-frames", "shift+arrowleft", "workspace.shell.keybindings.catalog.storyMotion.prevFrames", CATEGORY.storyMotion, ChevronsLeft),
    ...
    // --- Audio preview -------------------------------------------------------
    entry("assets.audio.play-pause", "space", "assets.audio.keybindings.playPause", CATEGORY.assets, Play),
    entry("assets.audio.to-start", "home", "assets.audio.keybindings.toStart", CATEGORY.assets, SkipBack),
    entry("assets.audio.to-end", "end", "assets.audio.keybindings.toEnd", CATEGORY.assets, SkipForward),
    entry("assets.audio.nudge-back", "arrowleft", "assets.audio.keybindings.nudgeBack", CATEGORY.assets, ChevronLeft),
    entry("assets.audio.nudge-forward", "arrowright", "assets.audio.keybindings.nudgeForward", CATEGORY.assets, ChevronRight),
    entry("assets.audio.nudge-back-coarse", "shift+arrowleft", "assets.audio.keybindings.nudgeBackCoarse", CATEGORY.assets, ChevronsLeft),
    entry("assets.audio.nudge-forward-coarse", "shift+arrowright", "assets.audio.keybindings.nudgeForwardCoarse", CATEGORY.assets, ChevronsRight),
    ...
    entry("assets.audio.mark-in", "i", "assets.audio.keybindings.markIn", CATEGORY.assets, ArrowRightToLine),
    entry("assets.audio.mark-loop", "l", "assets.audio.keybindings.markLoop", CATEGORY.assets, Flag),
    entry("assets.audio.mark-out", "o", "assets.audio.keybindings.markOut", CATEGORY.assets, ArrowLeftToLine),
    entry("assets.audio.go-to-in", "shift+i", "assets.audio.keybindings.goToIn", CATEGORY.assets, ChevronFirst),
    entry("assets.audio.go-to-loop", "shift+l", "assets.audio.keybindings.goToLoop", CATEGORY.assets, Locate),
    entry("assets.audio.go-to-out", "shift+o", "assets.audio.keybindings.goToOut", CATEGORY.assets, ChevronLast),
    ...
    entry("assets.audio.clear-selection", "escape", "assets.audio.keybindings.clearSelection", CATEGORY.assets, SquareDashed),
