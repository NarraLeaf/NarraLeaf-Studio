...
export const AssetExtensions = {
    ...
    [AssetType.Audio]: [".mp3", ".wav", ".ogg", ".aac", ".m4a", ".flac", ".wma", ".aiff", ".ape", ".alac", ".opus", ".m4b", ".m4p", ".m4r", ".m4v", ".m4b", ".m4p", ".m4r", ".m4v"],
    [AssetType.Video]: [".mp4", ".avi", ".mov", ".wmv", ".flv", ".mkv", ".webm", ".m4v", ".m4b", ".m4p", ".m4r", ".m4v"],
    [AssetType.JSON]: [".json"],
    [AssetType.Font]: [".ttf", ".otf", ".woff", ".woff2", ".eot", ".svg"],
    [AssetType.Other]: [".bin", ".txt", ".log", ".csv", ".json", ".xml", ".html", ".css", ".js", ".ts", ".jsx", ".tsx", ".md", ".markdown", ".yml", ".yaml", ".toml", ".ini", ".cfg", ".conf", ".props", ".config", ".settings", ".props", ".config", ".settings"],
};
