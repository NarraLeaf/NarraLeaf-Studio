...
export class ModelService extends AssetServiceBase {
    ...
    public async readLocalModel(asset: Asset<AssetType.Model>): Promise<RequestStatus<AssetData<AssetType.Model>>> {
     ...
     * back to detection.
     */
    public resolveEntry(asset: Asset<AssetType.Model>, files: readonly string[]): ModelEntryResolution {
        ...
        const override = asset.extras?.modelEntry
            ? normalizeBundlePath(asset.extras.modelEntry)
            : null;
