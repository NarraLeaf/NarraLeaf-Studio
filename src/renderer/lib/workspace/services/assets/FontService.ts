...
export class FontService extends AssetServiceBase {
  public async readLocalFont(
    asset: Asset<AssetType.Font>
  ): Promise<RequestStatus<AssetData<AssetType.Font>>> {
  ...
  public async readFontFromBuffer(
    asset: Asset<AssetType.Font>,
    buffer: Uint8Array
  ): Promise<RequestStatus<AssetData<AssetType.Font>>> {
  ...
  private async getFontMetadata(
    _buffer: Uint8Array,
    _format: string
  ): Promise<Partial<Omit<FontAssetMetadata, "format" | "size">>> {
