import { CharacterPose, ICharacterAppearance, isCharacterAppearanceKind, PortraitCrop, PresetAppearance } from "./types";
    ...
    for (const form of named) {
        ...
        for (const variantName of ordered) {
            ...
            poses.push({
                ...
                folder: multipleForms ? formName : undefined,
                assetId,
                portrait: form.portrait ?? profilePortrait,
            });
        }
    }
