...
const corpus: Record<string, StoryScene> = {
    ...
    "characters, every channel": scene([
        ...
        { id: "c8", kind: "action", payload: { action: "character", operation: "exit", characterId: "char-alice", transform: { to: { position: { xalign: 0.5, yalign: 0.5 } } }, transition: { kind: "maskCircle", durationMs: 600 } } },
    ] as never),
    ...
    "the raw effect channel": scene([
        ...
        { id: "d2", kind: "action", payload: { action: "displayable", operation: "transform", target: { kind: "image", name: "bird", sourceBlockId: "d1" }, transform: { to: { position: { xalign: 0.75, yalign: 0.5 } }, durationMs: 500 } } },
        { id: "d3", kind: "action", payload: { action: "displayable", operation: "transform", target: { kind: "image", name: "bird", sourceBlockId: "d1" }, transform: { to: { maskAssetId: "asset-mask" }, durationMs: 400 } } },
        { id: "d4", kind: "action", payload: { action: "displayable", operation: "transform", target: { kind: "image", name: "bird", sourceBlockId: "d1" }, transform: { to: { maskAssetId: null } } } },
        { id: "d5", kind: "action", payload: { action: "displayable", operation: "transform", target: { kind: "image", name: "bird", sourceBlockId: "d1" }, transform: { to: { clipPath: "circle(40%)" } } } },
        { id: "d6", kind: "action", payload: { action: "displayable", operation: "transform", target: { kind: "image", name: "bird", sourceBlockId: "d1" }, transform: { to: { clipPath: null } } } },
        { id: "d7", kind: "action", payload: { action: "displayable", operation: "transform", target: { kind: "image", name: "bird", sourceBlockId: "d1" }, transform: { to: { filter: { blur: 4 } }, durationMs: 300, easing: "linear" } } },
        { id: "d8", kind: "action", payload: { action: "displayable", operation: "transform", target: { kind: "image", name: "bird", sourceBlockId: "d1" }, transform: { to: { filter: null } } } },
        { id: "d9", kind: "action", payload: { action: "displayable", operation: "transform", target: { builtin: "background", name: "Scene background", kind: "image" }, transform: { to: { backdropFilter: "blur(8px)" } } } },
        { id: "d10", kind: "action", payload: { action: "displayable", operation: "transform", target: { builtin: "background", name: "Scene background", kind: "image" }, transform: { to: { mixBlendMode: "multiply" } } } },
        { id: "d11", kind: "action", payload: { action: "displayable", operation: "transform", target: { kind: "image", name: "bird", sourceBlockId: "d1" }, transform: { to: { filter: { brightness: 0.5 } } } } },
        { id: "d12", kind: "action", payload: { action: "displayable", operation: "transform", target: { kind: "image", name: "bird", sourceBlockId: "d1" }, transform: { clipReveal: { kind: "circleReveal" }, durationMs: 600 } } },
        { id: "d13", kind: "action", payload: { action: "displayable", operation: "transform", target: { kind: "image", name: "bird", sourceBlockId: "d1" }, transform: { clipReveal: { kind: "circleClose" } } } },
        { id: "d14", kind: "action", payload: { action: "displayable", operation: "transform", target: { kind: "image", name: "bird", sourceBlockId: "d1" }, transform: { clipReveal: { kind: "wipe" } } } },
        { id: "d15", kind: "action", payload: { action: "displayable", operation: "show", target: { builtin: "background", name: "Scene background", kind: "image" }, transform: { to: { opacity: 1 }, durationMs: 300 } } },
    ...
    "camera, screen and scene verbs": scene([
        { id: "e1", kind: "action", payload: { action: "camera", operation: "transform", transform: { mode: "props", to: { position: { xalign: 0.25, yalign: 0.5 } }, durationMs: 800 } } },
        { id: "e2", kind: "action", payload: { action: "camera", operation: "transform", transform: { mode: "props", to: { zoom: 1.4 }, durationMs: 1200 } } },
        { id: "e3", kind: "action", payload: { action: "camera", operation: "transform", transform: { mode: "props", to: { rotation: 15 } } } },
        { id: "e4", kind: "action", payload: { action: "camera", operation: "transform", transform: { mode: "props", to: { filter: { brightness: 0.6 } }, durationMs: 500, easing: "easeIn" } } },
        { id: "e5", kind: "action", payload: { action: "camera", operation: "reset", durationMs: 300 } },
        { id: "e6", kind: "action", payload: { action: "camera", operation: "transform", transform: { mode: "animation", animationId: "anim-shake" } } },
        { id: "e7", kind: "action", payload: { action: "camera", operation: "transform", transform: { mode: "props", to: { lens: { preset: "blink", inMs: 200, outMs: 200, holdMs: 100, color: "#ffffff", easing: "linear" } } } } },
        { id: "e8", kind: "action", payload: { action: "camera", operation: "transform", transform: { mode: "props", to: { lens: { preset: "vignettePulse", amount: 0.6 } } } } },
        { id: "e14", kind: "action", payload: { action: "camera", operation: "transform", transform: { mode: "props", to: { look: { preset: "moonlight", intensity: 0.8 } }, durationMs: 700 } } },
        { id: "e15", kind: "action", payload: { action: "camera", operation: "transform", transform: { mode: "props", to: { filterRaw: "sepia(1) blur(2px)" } } } },
        ...
        { id: "e18", kind: "action", payload: { action: "camera", operation: "transform", transform: { mode: "props", to: { look: { preset: "hangover", intensity: 1 } }, durationMs: 650, easing: "easeInOut" } } },
        { id: "e16", kind: "action", payload: { action: "camera", operation: "transform", transform: { mode: "props", to: { lens: { preset: "slowBlink", inMs: 80, holdMs: 400, outMs: 900 } } } } },
        { id: "e17", kind: "action", payload: { action: "camera", operation: "transform", transform: { mode: "props", to: { lens: { preset: "vignettePulse", inner: 30, outer: 70 } } } } },
        { id: "e9", kind: "action", payload: { action: "nvl", transition: { to: { opacity: 1 }, durationMs: 400 } } },
