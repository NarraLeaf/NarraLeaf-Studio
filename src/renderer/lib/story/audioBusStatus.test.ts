...
const ALICE: ProjectAudioTrack = { id: "t_alice", name: "Alice", parentId: "voice", volume: 1, loop: false };
const WHISPER: ProjectAudioTrack = { id: "t_whisper", name: "Whisper", parentId: "t_alice", volume: 0.5, loop: false };
const FIELD: ProjectAudioTrack = { id: "t_field", name: "Field", parentId: null, volume: 1, loop: false };
...
describe("audioBusStatusLine", () => {
    ...
    it("falls back to the global volume for a bus that reaches master through none of the three", () => {
        expect(audioBusStatusLine(t, tracks(FIELD), "t_field", "sound"))
            .toBe("Field · project.audio.slider.global");
    });
    ...
    it("says nothing about volume", () => {
        ...
        const quiet: ProjectAudioTrack = { id: "t_quiet", name: "Quiet", parentId: "bgm", volume: 0.25, loop: false };
