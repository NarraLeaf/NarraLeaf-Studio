...
const PLUGIN_ID = "narraleaf.gallery";
const PANEL_ID = `${PLUGIN_ID}.panel`;
const STORE_NAMESPACE = `${PLUGIN_ID}.items`;
const DYNAMIC_OPTIONS_SOURCE = `${PLUGIN_ID}.items`;
const RUNTIME_UNLOCKED_KEY = `${PLUGIN_ID}.unlocked`;
...
function createGalleryBlueprintNodes(): BlueprintNodeDef[] {
    return [
        {
            type: `${PLUGIN_ID}.add`,
