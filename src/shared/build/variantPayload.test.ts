...
describe("collectReferencedAssetIds", () => {
    ...
    it("answers nothing for an id the library does not have", () => {
        expect(collectReferencedAssetIds({ a: "44444444-4444-4444-4444-444444444444" }, library))
            .toEqual(new Set());
    });
    ...
    it("finds the asset id half of a model bundle path", () => {
        expect(collectReferencedAssetIds({ a: `${KEPT}/motions/idle.motion3.json` }, library))
