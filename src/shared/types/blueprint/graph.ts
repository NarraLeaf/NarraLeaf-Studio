...
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_MOUSE_CLICK =
  "blueprint.event.head.mouseClick" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_MOUSE_DOUBLE_CLICK =
  "blueprint.event.head.mouseDoubleClick" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_MOUSE_ENTER =
  "blueprint.event.head.mouseEnter" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_MOUSE_LEAVE =
  "blueprint.event.head.mouseLeave" as const;
...
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_MOUSE_WHEEL =
  "blueprint.event.head.mouseWheel" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_RIGHT_CLICK =
  "blueprint.event.head.rightClick" as const;
...
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_ANY_KEY_DOWN =
  "blueprint.event.head.anyKeyDown" as const;
...
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_BEFORE_SURFACE_EXIT =
  "blueprint.event.head.beforeSurfaceExit" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_AFTER_SURFACE_ENTER =
  "blueprint.event.head.afterSurfaceEnter" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_ELEMENT_FLUSH =
  "blueprint.event.head.elementFlush" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_ELEMENT_CLICK =
  "blueprint.event.head.elementClick" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_SCROLL = "blueprint.event.head.scroll" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_ON_ANY_BROADCAST =
  "blueprint.event.head.onAnyBroadcast" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_ON_BROADCAST =
  "blueprint.event.head.onBroadcast" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_PAGE_EVENT = "blueprint.event.head.pageEvent" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_ITEM_RENDER =
  "blueprint.event.head.itemRender" as const;
...
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_LIST_ITEM_REFRESH =
  "blueprint.event.head.listItemRefresh" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_SELECTION_CHANGED =
  "blueprint.event.head.selectionChanged" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_SCROLL_END = "blueprint.event.head.scrollEnd" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_SLIDER_DRAG_START =
  "blueprint.event.head.sliderDragStart" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_SLIDER_VALUE_CHANGED =
  "blueprint.event.head.sliderValueChanged" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_SLIDER_DRAG_END =
  "blueprint.event.head.sliderDragEnd" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_TEXT_INPUT_VALUE_CHANGED =
  "blueprint.event.head.textInputValueChanged" as const;
/** Fires when the player commits the field (Enter), not on every keystroke. */
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_TEXT_INPUT_SUBMIT =
  "blueprint.event.head.textInputSubmit" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_SWITCH_CHANGED =
  "blueprint.event.head.switchChanged" as const;
/**
 ...
 */
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_SWITCH_TURNED_ON =
  "blueprint.event.head.switchTurnedOn" as const;
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_SWITCH_TURNED_OFF =
  "blueprint.event.head.switchTurnedOff" as const;
...
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_SURFACE_INIT =
  "blueprint.event.head.surfaceInit" as const;
/** Entry for surface `surfaceUnmount` lifecycle event (page left). */
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_SURFACE_UNMOUNT =
  "blueprint.event.head.surfaceUnmount" as const;
/** Entry for a specific NarraLeaf game preference change (e.g. BGM Volume) on the active live game. */
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_PREFERENCE_CHANGED =
  "blueprint.event.head.preferenceChanged" as const;
/** Entry for any NarraLeaf game preference change on the active live game. */
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_ANY_PREFERENCE_CHANGED =
  "blueprint.event.head.anyPreferenceChanged" as const;
/** Entry for application window fullscreen transitions (entered or left fullscreen). */
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_FULLSCREEN_CHANGED =
  "blueprint.event.head.fullscreenChanged" as const;
/**
 ...
 */
export const BLUEPRINT_NODE_TYPE_EVENT_HEAD_WINDOW_CLOSE_REQUESTED =
  "blueprint.event.head.windowCloseRequested" as const;
/**
 ...
 */
export function resolveBlueprintEventHeadTypesForUiSlot(
  slotId: string,
...
export function formatBlueprintKeyboardBinding(raw: unknown): string {
  ...
  const parts = BLUEPRINT_KEYBOARD_MODIFIER_ORDER.filter((flag) => binding[flag]).map(
    (flag) => BLUEPRINT_KEYBOARD_MODIFIER_LABELS[flag]
  );
...
export function formatBlueprintKeyboardBindingFromEvent(event: BlueprintKeyboardEventLike): string {
  ...
  const parts = BLUEPRINT_KEYBOARD_MODIFIER_ORDER.filter((flag) => Boolean(event[flag])).map(
    (flag) => BLUEPRINT_KEYBOARD_MODIFIER_LABELS[flag]
  );
  if (!keyModifier || !event[keyModifier]) {
    parts.push(keyboardBindingDisplayLabelForKey(key));
  }
  return parts.join("+");
}

export function blueprintKeyboardBindingMatchesEvent(
  raw: unknown,
  eventPayload?: BlueprintKeyboardEventLike
): boolean {
  const binding = parseBlueprintKeyboardBinding(raw);
  if (!binding) {
    return false;
...
function isFilteredKeyboardEventHeadType(nodeType: string): boolean {
  return (
    nodeType === BLUEPRINT_NODE_TYPE_EVENT_HEAD_KEY_DOWN ||
    nodeType === BLUEPRINT_NODE_TYPE_EVENT_HEAD_KEY_UP
  );
}
...
function matchesPreferenceChangeDispatch(
  ...
  const selectedKey = String(
    node.params?.[BLUEPRINT_NODE_PARAM_EVENT_HEAD_PREFERENCE_KEY] ?? ""
  ).trim();
  if (!selectedKey) {
...
function matchesDispatchPayload(
  ...
  if (isFilteredKeyboardEventHeadType(node.type)) {
    return blueprintKeyboardBindingMatchesEvent(
...
export const BLUEPRINT_NODE_TYPE_ELEMENT_CONTINUE_EVENT_BUBBLE =
  "blueprint.element.continueEventBubble" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_STOP_EVENT_BUBBLE =
  "blueprint.element.stopEventBubble" as const;
...
export const BLUEPRINT_NODE_TYPE_COLLECTION_ARRAY_LENGTH =
  "blueprint.collection.arrayLength" as const;
...
export const BLUEPRINT_NODE_TYPE_COLLECTION_ARRAY_INSERT =
  "blueprint.collection.arrayInsert" as const;
export const BLUEPRINT_NODE_TYPE_COLLECTION_ARRAY_REMOVE =
  "blueprint.collection.arrayRemove" as const;
export const BLUEPRINT_NODE_TYPE_COLLECTION_ARRAY_REMOVE_AT =
  "blueprint.collection.arrayRemoveAt" as const;
export const BLUEPRINT_NODE_TYPE_COLLECTION_ARRAY_CONTAINS =
  "blueprint.collection.arrayContains" as const;
export const BLUEPRINT_NODE_TYPE_COLLECTION_ARRAY_FIND = "blueprint.collection.arrayFind" as const;
export const BLUEPRINT_NODE_TYPE_COLLECTION_ARRAY_FILTER =
  "blueprint.collection.arrayFilter" as const;
...
export const BLUEPRINT_NODE_TYPE_COLLECTION_ARRAY_SLICE =
  "blueprint.collection.arraySlice" as const;
export const BLUEPRINT_NODE_TYPE_COLLECTION_ARRAY_JOIN = "blueprint.collection.arrayJoin" as const;
export const BLUEPRINT_NODE_TYPE_COLLECTION_OBJECT_KEYS =
  "blueprint.collection.objectKeys" as const;
export const BLUEPRINT_NODE_TYPE_COLLECTION_OBJECT_VALUES =
  "blueprint.collection.objectValues" as const;
export const BLUEPRINT_NODE_TYPE_COLLECTION_OBJECT_MERGE =
  "blueprint.collection.objectMerge" as const;
export const BLUEPRINT_NODE_TYPE_COLLECTION_OBJECT_SET_FIELD =
  "blueprint.collection.objectSetField" as const;
export const BLUEPRINT_NODE_TYPE_COLLECTION_OBJECT_REMOVE_FIELD =
  "blueprint.collection.objectRemoveField" as const;
...
export const BLUEPRINT_NODE_TYPE_COMPARE_GREATER_THAN_OR_EQUAL =
  "blueprint.compare.greaterThanOrEqual" as const;
export const BLUEPRINT_NODE_TYPE_COMPARE_LESS_THAN = "blueprint.compare.lessThan" as const;
export const BLUEPRINT_NODE_TYPE_COMPARE_LESS_THAN_OR_EQUAL =
  "blueprint.compare.lessThanOrEqual" as const;
...
export const BLUEPRINT_NODE_TYPE_STRING_EQUALS_IGNORE_CASE =
  "blueprint.string.equalsIgnoreCase" as const;
...
export const BLUEPRINT_NODE_TYPE_STRING_NORMALIZE_LINE_BREAKS =
  "blueprint.string.normalizeLineBreaks" as const;
 ...
 */
export const BLUEPRINT_TIME_DURATION_STYLES = [
  "auto",
  "hoursMinutesSeconds",
  "minutesSeconds"
] as const;
...
export const BLUEPRINT_NODE_TYPE_BROADCAST_GET_LISTENER_COUNT =
  "blueprint.broadcast.getListenerCount" as const;
...
export const BLUEPRINT_NODE_TYPE_PAGE_IS_SURFACE_EXITING =
  "blueprint.page.isSurfaceExiting" as const;
export const BLUEPRINT_NODE_TYPE_PAGE_IS_SURFACE_ENTERING =
  "blueprint.page.isSurfaceEntering" as const;
export const BLUEPRINT_NODE_TYPE_PAGE_IS_SURFACE_TRANSITIONING =
  "blueprint.page.isSurfaceTransitioning" as const;
...
export const BLUEPRINT_NODE_TYPE_GAME_SAVE_GET_METADATA =
  "blueprint.game.save.getMetadata" as const;
...
export const BLUEPRINT_NODE_TYPE_GAME_HISTORY_UNDO_LAST =
  "blueprint.game.history.undoLast" as const;
...
export const BLUEPRINT_NODE_TYPE_GAME_GET_SPEAKER_AVATAR =
  "blueprint.game.getSpeakerAvatar" as const;
...
export const BLUEPRINT_NODE_TYPE_GAME_GET_NOTIFICATIONS =
  "blueprint.game.getNotifications" as const;
...
export const BLUEPRINT_NODE_TYPE_GAME_TOGGLE_DIALOG_DISPLAY =
  "blueprint.game.toggleDialogDisplay" as const;
export const BLUEPRINT_NODE_TYPE_GAME_SET_SENTENCE_SPEED =
  "blueprint.game.setSentenceSpeed" as const;
...
export const BLUEPRINT_NODE_TYPE_GAME_GET_VOICE_FADE_DURATION =
  "blueprint.game.getVoiceFadeDuration" as const;
export const BLUEPRINT_NODE_TYPE_GAME_SET_VOICE_FADE_DURATION =
  "blueprint.game.setVoiceFadeDuration" as const;
export const BLUEPRINT_NODE_TYPE_GAME_GET_VOICE_END_MODE =
  "blueprint.game.getVoiceEndMode" as const;
export const BLUEPRINT_NODE_TYPE_GAME_SET_VOICE_END_MODE =
  "blueprint.game.setVoiceEndMode" as const;
 ...
 */
export const BLUEPRINT_NODE_TYPE_GAME_GET_SKIP_READ_TEXT =
  "blueprint.game.getSkipReadText" as const;
export const BLUEPRINT_NODE_TYPE_GAME_SET_SKIP_READ_TEXT =
  "blueprint.game.setSkipReadText" as const;
...
export const BLUEPRINT_NODE_TYPE_NETWORK_READ_RESPONSE_TEXT =
  "blueprint.network.readResponseText" as const;
export const BLUEPRINT_NODE_TYPE_NETWORK_READ_RESPONSE_JSON =
  "blueprint.network.readResponseJson" as const;
...
export const BLUEPRINT_NETWORK_METHODS_WITH_BODY: readonly BlueprintNetworkMethod[] = [
  "POST",
  "PUT",
  "PATCH"
];
...
// in `resolveSelfOutput` in `graphParamResolvers.ts`.
export const BLUEPRINT_NODE_TYPE_LOCALIZATION_GET_CURRENT_LANGUAGE =
  "blueprint.localization.getCurrentLanguage" as const;
export const BLUEPRINT_NODE_TYPE_LOCALIZATION_SET_LANGUAGE =
  "blueprint.localization.setLanguage" as const;
...
export const BLUEPRINT_NODE_TYPE_LOCALIZATION_FORMAT_TEXT =
  "blueprint.localization.formatText" as const;
export const BLUEPRINT_NODE_TYPE_LOCALIZATION_GET_AVAILABLE_LANGUAGES =
  "blueprint.localization.getAvailableLanguages" as const;
...
export const BLUEPRINT_NODE_TYPE_VOICE_GET_AVAILABLE_LANGUAGES =
  "blueprint.voice.getAvailableLanguages" as const;
...
export const BLUEPRINT_NODE_TYPE_FRAME_WIDGET_SET_PAGE =
  "blueprint.frameWidget.setTargetPage" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_FRAME_SET_PAGE =
  "blueprint.element.frame.setTargetPage" as const;
...
export const BLUEPRINT_NODE_TYPE_TEXT_GET_TEXT_VERTICAL_ALIGN =
  "blueprint.text.getTextVerticalAlign" as const;
export const BLUEPRINT_NODE_TYPE_TEXT_SET_TEXT_VERTICAL_ALIGN =
  "blueprint.text.setTextVerticalAlign" as const;
...
export const BLUEPRINT_NODE_TYPE_TEXT_GET_ALL_PROPERTIES =
  "blueprint.text.getAllProperties" as const;
export const BLUEPRINT_NODE_TYPE_TEXT_SET_ALL_PROPERTIES =
  "blueprint.text.setAllProperties" as const;
...
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_APPEND_TEXT =
  "blueprint.element.text.appendText" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_CLEAR_TEXT =
  "blueprint.element.text.clearText" as const;
...
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_GET_FONT_SIZE =
  "blueprint.element.text.getFontSize" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_SET_FONT_SIZE =
  "blueprint.element.text.setFontSize" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_GET_FONT_WEIGHT =
  "blueprint.element.text.getFontWeight" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_SET_FONT_WEIGHT =
  "blueprint.element.text.setFontWeight" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_GET_TEXT_COLOR =
  "blueprint.element.text.getTextColor" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_SET_TEXT_COLOR =
  "blueprint.element.text.setTextColor" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_GET_TEXT_ALIGN =
  "blueprint.element.text.getTextAlign" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_SET_TEXT_ALIGN =
  "blueprint.element.text.setTextAlign" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_GET_TEXT_VERTICAL_ALIGN =
  "blueprint.element.text.getTextVerticalAlign" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_SET_TEXT_VERTICAL_ALIGN =
  "blueprint.element.text.setTextVerticalAlign" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_GET_LINE_HEIGHT =
  "blueprint.element.text.getLineHeight" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_SET_LINE_HEIGHT =
  "blueprint.element.text.setLineHeight" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_GET_WRAP_MODE =
  "blueprint.element.text.getWrapMode" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_SET_WRAP_MODE =
  "blueprint.element.text.setWrapMode" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_GET_EFFECTS =
  "blueprint.element.text.getEffects" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_SET_EFFECTS =
  "blueprint.element.text.setEffects" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_GET_ALL_PROPERTIES =
  "blueprint.element.text.getAllProperties" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_SET_ALL_PROPERTIES =
  "blueprint.element.text.setAllProperties" as const;

export const BLUEPRINT_NODE_TYPE_ELEMENT_DISPLAYABLE_GET_POSITION =
  "blueprint.element.displayable.getPosition" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_DISPLAYABLE_GET_SIZE =
  "blueprint.element.displayable.getSize" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_DISPLAYABLE_GET_BOUNDS =
  "blueprint.element.displayable.getBounds" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_DISPLAYABLE_GET_ROTATION =
  "blueprint.element.displayable.getRotation" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_DISPLAYABLE_GET_OPACITY =
  "blueprint.element.displayable.getOpacity" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_DISPLAYABLE_GET_VISIBLE =
  "blueprint.element.displayable.getVisible" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_DISPLAYABLE_GET_DISPLAY =
  "blueprint.element.displayable.getDisplay" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_DISPLAYABLE_GET_PROPERTY =
  "blueprint.element.displayable.getProperty" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_DISPLAYABLE_SET_DISPLAY =
  "blueprint.element.displayable.setDisplay" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_DISPLAYABLE_SET_PROPERTY =
  "blueprint.element.displayable.setProperty" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_DISPLAYABLE_GET_VARIANT =
  "blueprint.element.displayable.getVariant" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_DISPLAYABLE_SET_VARIANT =
  "blueprint.element.displayable.setVariant" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_DISPLAYABLE_ANIMATE_PROPERTY =
  "blueprint.element.displayable.animateProperty" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_DISPLAYABLE_STOP_ANIMATION =
  "blueprint.element.displayable.stopAnimation" as const;

export const BLUEPRINT_NODE_TYPE_DISPLAYABLE_GET_POSITION =
  "blueprint.displayable.getPosition" as const;
export const BLUEPRINT_NODE_TYPE_DISPLAYABLE_GET_SIZE = "blueprint.displayable.getSize" as const;
export const BLUEPRINT_NODE_TYPE_DISPLAYABLE_GET_BOUNDS =
  "blueprint.displayable.getBounds" as const;
export const BLUEPRINT_NODE_TYPE_DISPLAYABLE_GET_ROTATION =
  "blueprint.displayable.getRotation" as const;
export const BLUEPRINT_NODE_TYPE_DISPLAYABLE_GET_OPACITY =
  "blueprint.displayable.getOpacity" as const;
export const BLUEPRINT_NODE_TYPE_DISPLAYABLE_GET_VISIBLE =
  "blueprint.displayable.getVisible" as const;
export const BLUEPRINT_NODE_TYPE_DISPLAYABLE_GET_DISPLAY =
  "blueprint.displayable.getDisplay" as const;
export const BLUEPRINT_NODE_TYPE_DISPLAYABLE_GET_PROPERTY =
  "blueprint.displayable.getProperty" as const;
export const BLUEPRINT_NODE_TYPE_DISPLAYABLE_SET_DISPLAY =
  "blueprint.displayable.setDisplay" as const;
export const BLUEPRINT_NODE_TYPE_DISPLAYABLE_SET_PROPERTY =
  "blueprint.displayable.setProperty" as const;
export const BLUEPRINT_NODE_TYPE_DISPLAYABLE_GET_VARIANT =
  "blueprint.displayable.getVariant" as const;
export const BLUEPRINT_NODE_TYPE_DISPLAYABLE_SET_VARIANT =
  "blueprint.displayable.setVariant" as const;
export const BLUEPRINT_NODE_TYPE_DISPLAYABLE_ANIMATE_PROPERTY =
  "blueprint.displayable.animateProperty" as const;
export const BLUEPRINT_NODE_TYPE_DISPLAYABLE_STOP_ANIMATION =
  "blueprint.displayable.stopAnimation" as const;

export const BLUEPRINT_NODE_TYPE_SLIDER_GET_VALUE = "blueprint.slider.getValue" as const;
export const BLUEPRINT_NODE_TYPE_SLIDER_GET_NORMALIZED_VALUE =
  "blueprint.slider.getNormalizedValue" as const;
...
export const BLUEPRINT_NODE_TYPE_ELEMENT_SLIDER_GET_VALUE =
  "blueprint.element.slider.getValue" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_SLIDER_GET_NORMALIZED_VALUE =
  "blueprint.element.slider.getNormalizedValue" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_SLIDER_GET_RANGE =
  "blueprint.element.slider.getRange" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_SLIDER_SET_VALUE =
  "blueprint.element.slider.setValue" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_SLIDER_SET_RANGE =
  "blueprint.element.slider.setRange" as const;
...
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_INPUT_GET_VALUE =
  "blueprint.element.textInput.getValue" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_INPUT_SET_VALUE =
  "blueprint.element.textInput.setValue" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_TEXT_INPUT_CLEAR =
  "blueprint.element.textInput.clear" as const;
...
export const BLUEPRINT_NODE_TYPE_ELEMENT_SWITCH_GET_CHECKED =
  "blueprint.element.switch.getChecked" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_SWITCH_SET_CHECKED =
  "blueprint.element.switch.setChecked" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_SWITCH_TOGGLE = "blueprint.element.switch.toggle" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_SWITCH_TURN_ON =
  "blueprint.element.switch.turnOn" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_SWITCH_TURN_OFF =
  "blueprint.element.switch.turnOff" as const;
...
export const BLUEPRINT_NODE_TYPE_LIST_GET_SELECTED_INDEX =
  "blueprint.list.getSelectedIndex" as const;
export const BLUEPRINT_NODE_TYPE_LIST_SET_SELECTED_INDEX =
  "blueprint.list.setSelectedIndex" as const;
...
export const BLUEPRINT_NODE_TYPE_ELEMENT_LIST_SET_ITEMS =
  "blueprint.element.list.setItems" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_LIST_GET_ITEMS =
  "blueprint.element.list.getItems" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_LIST_CLEAR = "blueprint.element.list.clear" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_LIST_APPEND_ITEM =
  "blueprint.element.list.appendItem" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_LIST_INSERT_ITEM =
  "blueprint.element.list.insertItem" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_LIST_REMOVE_ITEM =
  "blueprint.element.list.removeItem" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_LIST_REMOVE_ITEM_AT =
  "blueprint.element.list.removeItemAt" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_LIST_GET_SELECTED_ITEM =
  "blueprint.element.list.getSelectedItem" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_LIST_SET_SELECTED_ITEM =
  "blueprint.element.list.setSelectedItem" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_LIST_GET_SELECTED_INDEX =
  "blueprint.element.list.getSelectedIndex" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_LIST_SET_SELECTED_INDEX =
  "blueprint.element.list.setSelectedIndex" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_LIST_REFRESH_ITEMS =
  "blueprint.element.list.refreshItems" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_LIST_SCROLL_TO_INDEX =
  "blueprint.element.list.scrollToIndex" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_LIST_SCROLL_TO_TOP =
  "blueprint.element.list.scrollToTop" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_LIST_SCROLL_TO_BOTTOM =
  "blueprint.element.list.scrollToBottom" as const;
...
export const BLUEPRINT_NODE_TYPE_ELEMENT_IMAGE_GET_ASSET =
  "blueprint.element.image.getImageAsset" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_IMAGE_SET_ASSET =
  "blueprint.element.image.setImageAsset" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_IMAGE_CLEAR_ASSET =
  "blueprint.element.image.clearImageAsset" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_IMAGE_GET_FIT_MODE =
  "blueprint.element.image.getFitMode" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_IMAGE_SET_FIT_MODE =
  "blueprint.element.image.setFitMode" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_IMAGE_GET_CROP_RECT =
  "blueprint.element.image.getCropRect" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_IMAGE_SET_CROP_RECT =
  "blueprint.element.image.setCropRect" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_IMAGE_GET_FLIP_X =
  "blueprint.element.image.getFlipX" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_IMAGE_SET_FLIP_X =
  "blueprint.element.image.setFlipX" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_IMAGE_GET_FLIP_Y =
  "blueprint.element.image.getFlipY" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_IMAGE_SET_FLIP_Y =
  "blueprint.element.image.setFlipY" as const;

export const BLUEPRINT_NODE_TYPE_BUTTON_SET_POINTER = "blueprint.button.setPointer" as const;
export const BLUEPRINT_NODE_TYPE_ELEMENT_BUTTON_SET_POINTER =
  "blueprint.element.button.setPointer" as const;
