...
import type {
  UITemplateBundle,
  UITemplateFetchResult,
  UITemplatePreview,
  UIThemePreview
} from "./uiTemplateRegistry";
...
import type { PrivilegedActor, PrivilegedBashExecuteResult } from "./privileged";
...
export interface RendererPrivilegedInterface {
  fs: {
    ...
    selectSaveFile(
      ...
      filters: string[]
    ): Promise<RequestStatus<FsRequestResult<string | null>>>;
  ...
  bash: {
    execute(
      ...
      command: string,
      cwd?: string
    ): Promise<RequestStatus<PrivilegedBashExecuteResult>>;
  };
}
...
export interface RendererPreloadedInterface {
  ...
  mediaConvert: {
    ...
    ): Promise<RequestStatus<{ state: MediaConvertStateSnapshot }>>;
  ...
  workspace: {
    ...
    exportProjectPackage(projectPath: string): Promise<
      RequestStatus<{
        canceled: boolean;
        packagePath?: string;
        fileCount?: number;
  ...
  app: {
    ...
    state: {
      getGlobalState<K extends GlobalStateKeys>(
        key: K
      ): Promise<RequestStatus<{ value: GlobalStateValue<K> }>>;
      setGlobalState<K extends GlobalStateKeys>(
        key: K,
      ...
      deleteGlobalState(
        keys: string[]
      ): Promise<RequestStatus<{ deleted: string[]; refused: string[] }>>;
      /**
      ...
      onGlobalStateChanged(
        handler: (change: { key: GlobalStateKeys; value: any }) => void
      ): AppEventToken;
    };
     ...
     */
    probeDownloadSource(url: string): Promise<
      RequestStatus<{
        reachable: boolean;
        status?: number;
        error?: string;
  ...
  devMode: {
    launch(
      projectPath: string,
      entry: DevModeEntry
    ): Promise<RequestStatus<{ status: DevModeStatus }>>;
  ...
  preview: {
    ...
    ): Promise<RequestStatus<{ status: PreviewStatus }>>;
  ...
  gameBuild: {
    ...
    preflight(
      projectPath: string,
      request: GameBuildRequest
    ): Promise<RequestStatus<{ findings: BuildPreflightFinding[] }>>;
  };
  ...
  signing: {
    ...
    ): Promise<RequestStatus<{ credential: SigningCredential }>>;
    ...
    ): Promise<RequestStatus<{ aliases: string[] }>>;
    /**
  ...
  pluginBuildSecret: {
    ...
    set(
      value: string,
      handle?: string
    ): Promise<RequestStatus<{ handle: string; available: boolean }>>;
    /**
