...
import type { EditMenuRole, MenuActionId, NativeMenuModel } from "./menu";
...
export type IPCEvents = {
  ...
  IPCGameBuildEvents &
  IPCSigningEvents &
  IPCPluginBuildSecretEvents &
  IPCBlueprintPersistenceEvents &
  IPCPluginPermissionEvents &
  IPCPluginManagerEvents &
  IPCUITemplateEvents &
  IPCAssetEvents &
  IPCPrivilegedEvents &
  IPCVcsEvents &
  IPCServerTrustEvents;
