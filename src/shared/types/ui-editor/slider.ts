...
export function getUISliderChildSlot(
  extra: Record<string, unknown> | undefined
): UISliderChildSlot | null {
...
export function clampSliderValue(
  value: unknown,
  rangeInput: Partial<UISliderRange> | undefined
): number {
...
export function normalizedSliderValueToMapped(
...
export function resolveSliderRuntimeValue(
  raw: Record<string, unknown> | undefined
