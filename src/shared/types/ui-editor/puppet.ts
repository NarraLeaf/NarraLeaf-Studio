 ...
 *
 * The stored type is `nl.puppet`: one widget covering Spine, Live2D and anything else an author
 ...
 * to). The *author-facing* name does say "Spine / Live2D Model", because a widget called "Puppet"
