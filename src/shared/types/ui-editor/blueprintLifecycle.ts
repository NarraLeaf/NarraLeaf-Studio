...
const GAME_PREFERENCE_EVENTS: readonly LifecycleEventDef[] = [
  {
    ...
    description:
      "Fires when a NarraLeaf game preference (e.g. BGM Volume) changes on the active live game.",
    dispatchKind: "interaction",
    headNodeTypes: [
...
const WINDOW_CLOSE_EVENTS: readonly LifecycleEventDef[] = [
  {
    ...
    description:
      "Fires when the user asks to close the window; run Stop Event Bubble to cancel the close.",
    dispatchKind: "interaction",
...
export const STORY_ACTION_LIFECYCLE_EVENTS: readonly LifecycleEventDef[] = [
  {
    ...
    displayName: "On Call",
    description:
      "Fires when the story invokes this blueprint (as an action, or to compute a value).",
    dispatchKind: "interaction",
