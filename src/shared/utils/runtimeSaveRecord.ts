import { DEV_MODE_SAVE_TYPE_NORMAL, type DevModeSaveRecord } from "@shared/types/devModeSave";
...
export function parseRuntimeSaveRecord(value: unknown): DevModeSaveRecord | null {
  ...
  return {
    metadata: {
      ...
      ...(typeof record.metadata.capture === "string" && record.metadata.capture
        ? { capture: record.metadata.capture }
        : {}),
