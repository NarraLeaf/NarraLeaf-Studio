...
export const game = {
    saveLoad: {
        ...
        relaunchedRow: "セーブの読み込み：「{id}」は別のビルドのものなので、止まった行からストーリーを開始し直した",
        relaunchedScene: "セーブの読み込み：「{id}」は別のビルドのもので、止まった行はもう無いため、そのシーンの先頭から開始し直した",
        detail: {
            ...
            unanchored: "このセーブはどこで止まったかを持たないため、そこから開始し直せない",
            sceneGone: "このセーブがいたシーンはこのビルドに無いため、開始し直す先が無い",
            relaunch: "セーブが止まった場面からストーリーを開始し直せなかった。{error}",
