...
export const properties = {
    ...
    scene: {
        ...
        input: {
            ...
            modePass: "通す",
            modeNone: "無視する",
            modeHintCapture: "入力はこのインターフェースで止まる",
            modeHintPass: "このインターフェースが応答したうえで、入力は下へ進む",
            modeHintNone: "入力はこのインターフェースをそのまま通り過ぎる",
            actions: "応答するアクション",
            actionsEmpty: "このプロジェクトにはまだ入力アクションがない",
            answer: "{name} に応答する",
            bindingMode: "割り当て",
            bindingModeDefault: "プロジェクトの既定",
            bindingModeAdd: "既定に追加する",
            bindingModeReplace: "これに差し替える",
            consume: "応答したらそこで止める",
            overControls: "操作できる要素の上では",
            overControlsSkip: "譲る",
            overControlsFire: "そのまま発火する",
        },
    },
    diagnostics: {
        title: "静的な検査",
    ...
    references: {
        ...
        dormant: "無効",
        dormantHint: "ウィジェットには保存されているが描画されない。塗りが色に設定されているため。このアセットを削除するとこの設定も消える",
        kind: {
            story: "ストーリー",
            blueprint: "ブループリント",
            uiElement: "インターフェース",
