...
export const properties = {
    ...
    scene: {
        ...
        input: {
            title: "入力",
            actions: "応答するアクション",
            answersNone: "このインターフェースは応答するアクションがない",
            addActions: "アクションを追加",
            addTitle: "アクションを追加",
            addEmpty: "このプロジェクトのアクションはすべて応答済み",
            addConfirm: "追加",
            addCreate: "アクションを作成",
    ...
    asset: {
        ...
        // ローカルアセットの出どころ。リモートアセットの取得元と更新確認が出る場所に置く。
        local: {
            origin: "プロジェクトが持っているのは、この端末にあるファイルの複製。Studio はそのファイルを追跡しない。変更を取り込むには「ファイルを差し替え」を使う",
        },
        image: {
            title: "画像のプロパティ",
            info: "画像の情報",
