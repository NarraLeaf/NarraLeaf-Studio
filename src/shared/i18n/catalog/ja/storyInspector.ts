...
export const storyInspector = {
    ...
    transitionHint: {
        ...
        darkness: "開始の暗さで画像を入れ替え、終了の暗さまで動かす。1 → 0 は暗転から明ける。明るさは切り替えの間だけ続く",
        throughColor: "画面をいったん色で覆い、そこで保持してから、新しい画像の上で外す。暗転や白転、アイリス、フラッシュ（保持なし）に使う",
    ...
    control: {
        ...
        quitPage: "終了後に表示するページ",
        quitPageUnset: "未設定",
        quitHint: "このプレイはこの行で終了し、ページが表示される。エンディングは記録しない。",
        branch: "枝",
