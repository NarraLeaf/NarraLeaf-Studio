...
export const storyInspector = {
  ...
  transitionHint: {
    ...
    darkness:
      "開始の暗さで画像を入れ替え、終了の暗さまで動かす。1 → 0 は暗転から明け、0 → 1 は暗転へ落とす",
    throughColor:
      "画面をいったん色で覆い、保持してから、新しい画像の上で外す。暗転や白転、アイリス、フラッシュ（保持 0）に使う"
  },
  ...
  control: {
    ...
    cutVariant: "ビルドバリアント",
    cutHint:
      "このビルドはこの行で終わり、これより後は何も入らない。他のビルドは変わらず、この行も入らない",
  ...
  condition: {
    brokenExpression:
      "この式はもう解決できない。読んでいる変数の名前が変わったか、削除された可能性がある。式を直すまで、この枝は偽のまま",
    clear: "条件を消す"
  },
