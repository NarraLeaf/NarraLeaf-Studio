...
export const project = {
    ...
    settings: {
        ...
        imageModeTitle: "画像の設定",
        imageModeDescription: "自動は品質ひとつ。詳細ではエンコーダーの値を指定する",
        imageWebpQualityTitle: "WebP の品質",
        imageWebpQualityDescription: "WebP エンコーダーに渡す品質。1 から 100 まで",
        imageMaxDimensionTitle: "最大の辺",
        imageMaxDimensionDescription: "長辺がこのピクセル数を超える画像は縮小される。0 なら保存されたときの大きさのまま",
        audioModeTitle: "音声の設定",
        audioModeDescription: "自動は品質ひとつ。詳細ではエンコーダーの値を指定する",
        audioBitrateKbpsTitle: "ビットレート",
        ...
        videoModeTitle: "映像の設定",
        videoModeDescription: "自動は品質ひとつ。詳細ではエンコーダーの値を指定する",
        videoCrfTitle: "CRF",
        videoCrfDescription: "VP9 の CRF。小さいほど高画質になり、ファイルは大きくなる",
        videoMaxHeightTitle: "最大の高さ",
