...
export const project = {
    ...
    settings: {
        ...
        networkAllowlistTitle: "許可一覧の要求だけ許可",
        networkAllowlistDescription: "ネットワーク要求許可一覧のアドレスだけを要求できる。ほかの要求は拒否される",
        networkAllowlistWebHint: "すべてのビルドで有効。Web 書き出しではページのポリシーで適用される",
        networkAllowlist: {
            title: "ネットワーク要求の許可一覧",
