...
export const workspace = {
    ...
    team: {
        ...
        // 取り消せず、プロジェクトを凍結する。
        liveStartWhat: "開始すると、チェックポイントを記録してサーバーに送り、ストーリー・キャスト・翻訳と音声・アセットライブラリ以外のこのプロジェクト全体を凍結する",
        liveJoinWhat: "参加すると、チェックポイントを記録し、この端末をセッションのバージョンに合わせ、ストーリー・キャスト・翻訳と音声・アセットライブラリ以外のこのプロジェクト全体を凍結する",
