...
export const workspace = {
    ...
    team: {
        ...
        // 取り消せず、プロジェクトを凍結する。
        liveStartWhat: "開始すると、チェックポイントを記録してサーバーに送り、対象のストーリー以外のこのプロジェクト全体を凍結する",
        liveJoinWhat: "参加すると、チェックポイントを記録し、この端末をセッションのバージョンに合わせ、対象のストーリー以外のこのプロジェクト全体を凍結する",
        ...
        liveFrozenWhat: "セッション中はそのストーリーだけが保存される。このプロジェクトの他の内容は最新の状態のまま読み取り専用になる",
        ...
        save: {
            ...
            frozenDetailSession: "ライブセッション中。保存されるのはそのストーリーだけで、ほかを変更するにはセッションから抜ける",
