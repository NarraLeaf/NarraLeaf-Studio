...
export const workspace = {
    ...
    team: {
        ...
        // 取り消せず、プロジェクトを凍結する。
        liveStartWhat: "開始すると、チェックポイントを記録してサーバーに送り、ストーリー・キャスト・翻訳と音声・アセットライブラリ・ビルドバリアント・DLC・パレット以外のこのプロジェクト全体を凍結する",
        liveJoinWhat: "参加すると、チェックポイントを記録し、この端末をセッションのバージョンに合わせ、ストーリー・キャスト・翻訳と音声・アセットライブラリ・ビルドバリアント・DLC・パレット以外のこのプロジェクト全体を凍結する",
        ...
        liveFrozenWhat: "セッション中はストーリー・キャスト・翻訳と音声・辞書・オーディオトラック・アセットセット、そしてアセットライブラリ全体（ファイルそのものを含む）が保存される。このプロジェクトの他の内容は最新の状態のまま読み取り専用になる",
