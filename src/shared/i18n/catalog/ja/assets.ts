...
export const assets = {
  ...
  import: {
    ...
    remoteDescription:
      "直接のリンクを貼る。ファイルはいまダウンロードされ、プロジェクトと一緒に保たれる",
  ...
  modelImport: {
    ...
    noneFoundHint:
      "上で選んだ種類を確かめ、次にフォルダを確かめる。書き出し側が作ったフォルダである必要がある",
    entry: "エントリ",
    ...
    tooManyFiles:
      "そのフォルダには {count} 個のファイルがあり、多すぎて調べられない。モデルが入っているフォルダを選ぶ"
  },
  menu: {
    newGroup: "新規グループ",
  ...
  fontPreview: {
    sampleText:
      "いろはにほへと ちりぬるを 永東国鷹 The quick brown fox jumps over the lazy dog 0123456789",
