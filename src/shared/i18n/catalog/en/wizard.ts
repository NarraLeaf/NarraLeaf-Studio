...
export const wizard = {
  ...
  project: {
    ...
    versionControlLoreHint:
      "A version history is created inside the project folder, recording the project as its first version.",
    versionControlUnavailablePlatform:
      "Version control is not available on this machine. The project is created without it.",
    versionControlUnavailableInstallation:
      "Version control is not available in this Studio build. The project is created without it.",
  ...
  stage: {
    ...
    scriptLocaleHelper:
      "The language the story is written in. Translations are added in the localization panel."
  },
  ...
  import: {
    ...
    error: {
      ...
      notAProject:
        "Unpacking finished, but the result holds no Studio project file. The unpacked contents are in {path}"
    }
  },
  ...
  source: {
    ...
    addressInvalid:
      "A project address needs the project's name on the end, like lore://studio.example.lan:41337/my-game",
    parsedServer: "Server",
  ...
  clone: {
    ...
    error: {
      ...
      notAProjectTitle: "This is not a NarraLeaf Studio project",
      notAProject:
        "The copy finished, but it holds no Studio project file. The copied contents are in {path}"
    }
  },
  review: {
    template: "Template",
  ...
  validation: {
    ...
    notADirectory:
      "That path exists but is not a directory. Choose a directory, or create a new one.",
