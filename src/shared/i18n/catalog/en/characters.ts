...
export const characters = {
    ...
    editor: {
        ...
        runtime: {
            ...
            sdkStep: "Choose the {product} SDK archive you downloaded, exactly as it downloaded — do not extract it.",
            ...
            renamed: "Installed as \"{backend}\" — that is the name this module registers, so use it on your characters.",
            remove: "Remove",
        ...
        avatarUnresolved: "No art to draw here — the character's default avatar is used.",
        rebake: "Re-bake avatars",
        bakeReceipt: "{written} written · {unresolved} without art · {removed} removed",
        bakeUpToDate: "Avatars are up to date",
    ...
    preview: {
        ...
        portraitPoseScopedOff: "Frame this pose only",
        portraitPoseScopedOn: "Framing this pose only — click to follow the character",
    },
    variantsPanel: {
        title: "Variants",
