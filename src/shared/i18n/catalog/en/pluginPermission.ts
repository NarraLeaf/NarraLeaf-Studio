...
export const pluginPermission = {
  ...
  install: {
    ...
    body2:
      "Approving this install grants everything listed to this plugin version. Only install plugins you trust.",
  ...
  permissions: {
    section: {
      ...
      externalLinkNote:
        "This plugin can send the player to these addresses, opened outside the game.",
