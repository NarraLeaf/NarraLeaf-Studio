...
export const pluginPermission = {
    ...
    permissions: {
        section: {
            ...
            sidecarNote: "This plugin ships a program inside the games built from this project.",
            buildDependency: "Build-time downloads",
            runtime: "In the game",
            externalLink: "Links out of the game",
        ...
        runtimeCapability: {
            ...
            locale: "Read and follow the game language, and read the project's own wording",
            menu: "Own the menu bar above the game",
