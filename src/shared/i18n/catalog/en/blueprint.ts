...
export const blueprint = {
  ...
  diagnostics: {
    ...
    interaction: {
      ...
      hiddenEventsHint:
        "Remove the events, or make the element visible. A hidden element receives no input.",
    ...
    graph: {
      ...
      pinMultipleInput:
        "Pin {node}.{port} has multiple input connections; each pin can only have one edge.",
      pinMultipleOutput:
        "Pin {node}.{port} has multiple output connections; each pin can only have one edge.",
    ...
    fn: {
      ...
      returnSignatureConflict:
        'Fn Return "{node}" declares different results than the first Return of this fn.',
      ...
      recursiveCall:
        'Fn "{name}" calls itself (directly or indirectly); the runtime aborts deep recursion.'
    },
    widget: {
  ...
  memberTree: {
    ...
    deleteVariableDetail:
      "Nodes that reference this variable lose their selection. This cannot be undone.",
    ...
    deletePersistentVariableDetail:
      "Nodes that reference this persistent variable lose their selection. Saved player data for this key is not deleted.",
