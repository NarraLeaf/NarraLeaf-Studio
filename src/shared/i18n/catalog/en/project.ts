...
export const project = {
    ...
    settings: {
        ...
        networkAllowlistTitle: "Only allowlisted requests",
        networkAllowlistDescription: "Only addresses on the network request allowlist can be requested. Every other request is refused.",
        networkAllowlistWebHint: "Enforced in every build. The Web export enforces it through the page policy.",
        networkAllowlist: {
