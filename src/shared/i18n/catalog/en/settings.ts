...
export const settings = {
  ...
  fontPicker: {
    ...
    denied:
      "Studio could not read the installed fonts. Bring this window to the front and reopen the list.",
  ...
  items: {
    ...
    tooltipDelay: {
      label: "Tooltip delay",
      description:
        "How long the pointer rests on a control before its tooltip appears. Within a toolbar the wait applies to the first tooltip only."
    },
    reduceMotion: {
      label: "Reduce motion",
      description:
        "Turn off animated transitions in the Studio interface. The game's own animations are unaffected."
    },
    zoomPercent: {
    ...
    editorFontFamily: {
      ...
      description:
        "Typeface used for story text in the scene editor. Any font installed on this computer can be chosen.",
    ...
    blueprintDragConnectDataOutput: {
      ...
      description:
        "Drop on empty canvas to pick a node; only nodes that accept that value type are listed."
    },
    ...
    spellcheckLanguage: {
       ...
       */
      noDictionary:
        "No spelling dictionary is installed for this project's language, so nothing in the script is marked. The project dictionary still holds the project's own terms.",
      options: {
    ...
    detachedEditorOnClose: {
      ...
      description:
        "An editor opened in its own window either returns to the workspace or closes with the window.",
      options: {
    ...
    pluginRegistryUrl: {
      ...
      description:
        "Where the plugin store looks. Leave empty to use the official NarraLeaf registry."
    },
    uiTemplateRegistryUrl: {
      label: "UI template registry URL",
      description:
        "Where the template store looks. Leave empty to use the official NarraLeaf registry."
    },
    checkpointInterval: {
    ...
    versionControlAuthor: {
      label: "Author name",
      description:
        "Recorded on commits and checkpoints. Leave empty to record NarraLeaf Studio instead.",
    ...
    versionControlAuthorEmail: {
      label: "Author email",
      description:
        'Recorded next to the author name, as "Name <email>". Leave empty to record no address.'
    },
    confirmBeforeClose: {
  ...
  dictionaries: {
    ...
    failed:
      "The dictionary list could not be read. Check the network policy in Settings, then try again.",
    /**
     ...
     */
    noDictionaryLanguages:
      "Chinese and Japanese have no spelling dictionary, and will not get one: neither language separates words, so there is nothing for a word list to check. A project written in either is never marked.",
    installed: {
    ...
    cache: {
      ...
      buckets: {
        ...
        spellcheckDictionaries: {
          label: "Spelling dictionaries",
          description:
            "Word lists downloaded for spellchecking. Your project's own terms are not here."
        },
        psdImports: {
  ...
  transfer: {
    ...
    apply: "Apply",
    exportHint:
      "Writes the settings to a plain JSON file. The workspace background, the name recorded on commits, recent projects, statistics and window layout stay on this machine.",
