...
export const storyInspector = {
  ...
  transitionHint: {
    ...
    darkness:
      "Swaps images at the starting darkness, then animates to the ending one. 1 → 0 emerges out of black, 0 → 1 dims into it.",
    throughColor:
      "Covers the frame with a color, holds, then uncovers on the new image. Use it for fade to black or white, iris to black, and flash (hold 0)."
  },
  ...
  control: {
    ...
    untilHint:
      "The group repeats while this is false and stops when it becomes true. The condition is checked before each pass.",
    breakHint:
      "Leaves the repeat group containing this row. It has no effect outside a repeat group.",
    cutVariant: "Build variant",
    cutHint:
      "This build ends at this line and contains nothing after it. Every other build is unchanged and does not contain this line.",
  ...
  condition: {
    brokenExpression:
      "This expression no longer resolves. A variable it reads may have been renamed or deleted. The branch stays false until the expression is fixed.",
