...
export const assets = {
  ...
  modelImport: {
    ...
    noneFoundHint:
      "Check the kind selected above, then the folder. It must be the folder the exporter wrote.",
    entry: "Entry",
    ...
    problem: {
      ...
      unusableReference:
        "The {role} “{raw}” is outside this folder and will not be copied with it.",
    ...
    tooManyFiles:
      "That folder holds {count} files, too many to check. Select the folder the models are in."
  },
  menu: {
    newGroup: "New Group",
