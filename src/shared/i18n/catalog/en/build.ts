...
export const build = {
    ...
    preflight: {
        ...
        "lossy-images": "Images are re-encoded at quality {setting} and lose detail permanently.",
        "lossy-audio": "Audio is re-encoded at {setting} kbit/s and loses detail permanently.",
        "lossy-video": "Video is re-encoded at CRF {setting} and loses detail permanently.",
        ...
        "unsigned-android": "Signed with a local debug identity. It works for sideloading, and an AAB signed with it is not usable as a Google Play upload key. Choose a release keystore to sign under a release identity.",
        ...
        "signing-credential-missing": "The {platform} signing credential is not on this machine. Import it here, or clear the selection to build {platform} unsigned.",
        ...
        "signing-host-unsupported": "This machine runs {host} and cannot sign for {platform} with the selected credential. Build this target on a {platform} machine.",
        ...
        "signing-macos-not-developer-id": "{identity} is not a \"Developer ID Application\" certificate. The build runs on this Mac. It is refused on other Macs and cannot be notarized.",
        "signing-android-not-play": "A signed APK works for sideloading and for stores such as itch.io. Google Play accepts only AAB packages. Turn on the AAB format under the Android target to produce one.",
