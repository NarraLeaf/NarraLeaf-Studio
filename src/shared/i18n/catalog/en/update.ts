...
export const update = {
  ...
  unsupported: {
    macos:
      "Studio cannot install its own updates on macOS yet. Download the new version and replace the app.",
    development: "A development build cannot update itself.",
    platform:
      "This build cannot install its own updates. Download the new version from the releases page."
  },
  setting: {
    checkOnLaunch: {
