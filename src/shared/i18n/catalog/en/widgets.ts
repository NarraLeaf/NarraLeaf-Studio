...
export const widgets = {
  ...
  list: {
    ...
    scrollbarPartsAuthoredHint:
      "Track and thumb are in the list outline. Select them to edit their appearance.",
    scrollbarCustomizeHint:
  ...
  switch: {
    ...
    defaultCheckedHint:
      "Flips the starting state the canvas previews, not the player's runtime state.",
  ...
  textInput: {
    ...
    value: "Value",
    valueHint:
      "Starting text. What the player types is held by the running game, not by this document.",
  ...
  video: {
    ...
    autoplay: "Autoplay",
    autoplayHint:
      "Applies in the game. The editor canvas stays paused; use the docker bar to preview.",
    volume: "Volume",
    ...
    preload: "Preload",
    preloadHint:
      "How much to fetch before playback. The canvas always loads metadata so that it can show a frame.",
    preloadNone: "None",
  ...
  puppet: {
    ...
    sectionBox: "Box",
    runtimeNotice:
      "Studio ships no model renderer. Place one in runtimes/puppet/<name>/index.js and select it below.",
    model: "Model bundle",
    ...
    describeBackendMissing:
      "That runtime is not installed in this project, so names must be typed.",
