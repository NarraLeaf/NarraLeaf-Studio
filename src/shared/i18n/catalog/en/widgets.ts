...
export const widgets = {
    ...
    video: {
        ...
        preload: "Preload",
        preloadHint: "How much to fetch before playback. The canvas always loads metadata so it can show a frame.",
        preloadNone: "None",
    ...
    puppet: {
        ...
        sectionState: "Pose",
        sectionBox: "Box",
        runtimeNotice: "Studio ships no model renderer. Put your own Spine2D or Live2D runtime in this project's runtimes/puppet/<name>/index.js and pick it below.",
        model: "Model bundle",
        ...
        backendNoneInstalled: "This project carries no runtime under runtimes/puppet yet.",
        options: "Runtime options",
        optionsHint: "A JSON object, passed to the runtime unchanged.",
        optionsInvalid: "Not a JSON object — the change was not saved.",
        motion: "Motion",
        ...
        describeBackendMissing: "That runtime is not installed here, so names are typed by hand.",
        describeNotSupported: "This runtime does not describe its models; type names by hand.",
        ...
        placeholderUnconfigured: "Pick a model bundle and a runtime.",
