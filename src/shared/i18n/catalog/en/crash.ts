...
export const crash = {
  ...
  screen: {
    ...
    detail:
      "Other Studio windows are unaffected. Reloading builds this window again from the files on disk.",
  ...
  rendererGone: {
    ...
    detailRepeated:
      "Reason: {reason}. This window has stopped working repeatedly, so it will not be reloaded again.",
    reload: "Reload",
    close: "Close window"
  },
