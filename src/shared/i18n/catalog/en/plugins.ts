...
export const plugins = {
  ...
  workspace: {
    ...
    activity: {
      ...
      runtimeOnlyHint:
        "This plugin only extends the running game. It contributes nothing to the editor.",
      suppressed: "Off for this project",
      suppressedHint:
        "The installed version is incompatible with the one this project was authored against. Update it, or update the project's dependency table from Project → Dependencies.",
      failed: "Failed to load"
    },
    // Warned once at load, naming the plugins this project's dependency table turned away.
    suppressedNotice:
      "Not loaded for this project: {names}. The installed version is incompatible with the one the project was authored against. See the Plugins panel.",
    ...
    recoveryNotice:
      "Recovery mode loads no plugins. Changes here apply the next time the project opens normally.",
