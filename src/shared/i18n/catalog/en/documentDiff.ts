...
export const documentDiff = {
  ...
  tier: {
    ...
    summaryHint:
      "The contents were not compared. These are the numbers each version reports about itself.",
    structural: "Structural",
    structuralHint:
      "Compared by JSON structure alone, so generated ids and reordered lists read as changes.",
    content: "Format only",
  ...
  presenter: {
    ...
    image: {
       ...
       */
      sizeDiffers:
        "The two versions are different sizes, so they cannot be compared pixel by pixel.",
  ...
  resolve: {
    ...
    rowsOmitted:
      "{count} more files are not listed here. Use the two links above to choose for all of them.",
    ...
    change: {
      ...
      blocked: {
        ...
        noMerge3:
          "Studio can read this format but cannot merge two versions of it change by change.",
        readOnly:
          "Studio can merge this format but cannot write the result back, so the whole file has to come from one side.",
        ...
        unreadable:
          "One of the two versions could not be read, so only the whole file can be taken."
      }
    }
  },
  /**
