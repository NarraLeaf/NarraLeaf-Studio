...
export const characters = {
    ...
    create: {
        ...
        runtimeGroup: "由运行时绘制",
        runtimeHint: "需要在本项目里安装对应的运行时，可在角色编辑器里安装。",
        colorLabel: "颜色",
        colorAutoHint: "不选颜色时，角色的颜色由名字决定——同一个名字在任何项目里都是同一个颜色。",
        colorReset: "使用名字计算",
    },
    editor: {
        ...
        runtime: {
            ...
            sdkStep: "选择你下载的 {product} SDK 压缩包，不要解压。",
            sdkPick: "选择 SDK 压缩包…",
            ...
            renamed: "已安装为“{backend}”，角色上要用这个名字。",
            remove: "移除",
