...
export const characters = {
  ...
  editor: {
    ...
    runtime: {
      ...
      live2dTerms:
        "Live2D Cubism 的授权方是 Live2D Inc.，不是 NarraLeaf；你在下载时接受 Cubism SDK 许可协议，并且在你构建的游戏中，分发方是你自己；商业发行若超过 Live2D 的年营收阈值，需另行向 Live2D 申请发布授权",
      spineTerms:
        "Spine Runtimes 的授权方是 Esoteric Software；每个使用 Spine 的人都需要自己的 Spine Editor 授权，且 Spine Runtimes License 必须随你发行的游戏一并提供；NarraLeaf 未持有 Spine 授权，因此 Studio 不含任何 Spine 代码，也无法代你构建适配器",
    ...
    diagnostics: {
      ...
      avatarCombinations: "将烘焙 {count} 张对白头像；缩小头像轴可减少数量",
