...
export const properties = {
    ...
    scene: {
        ...
        input: {
            ...
            modePass: "穿透",
            modeNone: "忽略",
            modeHintCapture: "输入到此界面为止",
            modeHintPass: "此界面先响应，输入再继续传给下层",
            modeHintNone: "输入直接越过此界面",
            actions: "响应的操作",
            actionsEmpty: "本工程还没有命名任何输入操作",
            answer: "响应 {name}",
            bindingMode: "绑定",
            bindingModeDefault: "工程默认",
            bindingModeAdd: "在默认之外追加",
            bindingModeReplace: "改用这些",
            consume: "响应后不再向下传",
            overControls: "落在控件上时",
            overControlsSkip: "让位",
            overControlsFire: "照样触发",
        },
    },
    diagnostics: {
        title: "静态检查",
