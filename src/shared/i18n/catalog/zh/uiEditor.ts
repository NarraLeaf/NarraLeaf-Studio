...
export const uiEditor = {
    ...
    panel: {
        ...
        emptyPagesHint: "使用上方的“新建页面”。页面可作为完整屏幕打开，之后也能作为游戏图层调用。",
        emptyGameUiHint: "使用上方的“新建游戏 UI”。游戏 UI 固定使用项目分辨率。",
        globalSubtitle: "全局",
        blueprintType: "蓝图",
    ...
    createDialog: {
        slotIntro: "选择此游戏 UI 在游戏运行时所属的位置。",
        slotAlreadyCreated: "已创建。请从列表中打开已有的游戏 UI。",
    ...
    editor: {
        ...
        devModeHint: "打开开发模式以进行真实执行、节点追踪和 Host API 调用。",
        layerFallback: "图层",
    },
    snap: {
        label: "智能吸附",
        tip: "智能吸附到参考线和相邻元素（按住 Alt 可临时关闭）",
        settings: "吸附设置",
        targets: "吸附目标",
