...
export const workspace = {
    ...
    team: {
        ...
        liveStartWhat: "开始会记录一个检查点、上传到服务器，并冻结此项目中除故事、角色、译文与配音、资产库、变量与命名字符串以外的一切",
        liveJoinWhat: "加入会记录一个检查点、把本机同步到该会话的版本，并冻结此项目中除故事、角色、译文与配音、资产库、变量与命名字符串以外的一切",
        ...
        save: {
            ...
            frozenDetailSession: "实时会话进行中，只有会话携带的内容会保存；离开会话后可以改动其余内容",
