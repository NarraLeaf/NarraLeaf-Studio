...
export const workspace = {
    ...
    team: {
        ...
        liveStartWhat: "开始会记录一个检查点、上传到服务器，并冻结此项目中除故事、角色、译文与配音、资产库、变体、DLC 与配色以外的一切",
        liveJoinWhat: "加入会记录一个检查点、把本机同步到该会话的版本，并冻结此项目中除故事、角色、译文与配音、资产库、变体、DLC 与配色以外的一切",
        ...
        liveFrozenWhat: "会话期间保存故事、角色、译文与配音、词典、音频轨道、资产集，以及整个资产库（含文件本身）；其余内容是当前的，且为只读",
