...
export const widgets = {
    ...
    video: {
        ...
        preload: "预加载",
        preloadHint: "播放前预取多少。画布始终加载元数据，以便显示一帧画面。",
        preloadNone: "不预加载",
    ...
    puppet: {
        ...
        sectionState: "姿态",
        sectionBox: "外框",
        runtimeNotice: "Studio 不提供模型渲染器。请把自备的 Spine2D 或 Live2D 运行时放到本工程的 runtimes/puppet/<名称>/index.js，然后在下方选择。",
        model: "模型包",
        modelNone: "未选择模型包",
        modelChoose: "选择模型",
        ...
        backendNoneInstalled: "本工程的 runtimes/puppet 下还没有任何运行时",
        options: "运行时选项",
