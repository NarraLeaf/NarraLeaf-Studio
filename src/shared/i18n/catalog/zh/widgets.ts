...
export const widgets = {
    ...
    typography: {
        ...
        autoFitTip: "文本超出控件尺寸时缩小字号，下限为最小字号；仍然超出的部分被裁切",
        alignment: "对齐",
        ...
        writingVerticalRl: "竖排，列从右向左",
        writingVerticalLr: "竖排，列从左向右",
        glyphOrientation: "字形方向",
        orientationMixed: "汉字直立，拉丁横倒",
        orientationUpright: "全部直立",
        orientationSideways: "全部横倒",
        tateChuYoko: "短串直立（縦中横）",
        tateChuYokoHint: "数字与短拉丁串横向排在一格内",
        tateChuYokoMaxLength: "直立组合的最大长度",
        italic: "斜体",
        enableItalic: "启用斜体",
        disableItalic: "禁用斜体",
    },
    ...
    puppet: {
        ...
        sectionState: "姿态",
        sectionBox: "外框",
        runtimeNotice: "Studio 不提供模型渲染器；将渲染器放到 runtimes/puppet/<名称>/index.js，然后在下方选择",
        model: "模型包",
        modelNone: "未选择模型包",
        modelChoose: "选择模型",
