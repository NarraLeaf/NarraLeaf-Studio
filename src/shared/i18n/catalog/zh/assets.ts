...
export const assets = {
    ...
    mediaConvert: {
        ...
        intro: "转换会在工程里生成新文件，你原来的文件留在原处不动。",
        ...
        group: {
            ...
            lossy: "可以转换，但会损失一些质量",
            lossyHint: "画面和声音会被重新生成，需要一些时间，效果会略有下降。",
            refused: "无法导入",
        },
        becomes: "转成 .{ext}",
        refusal: {
    ...
    modelImport: {
        title: "导入模型",
        familyStep: "这是哪一种模型？",
        familyNoRuntime: "这里不安装任何东西。绘制用的运行时之后在角色上设置。",
        family: {
        ...
        folderStep: "选择文件夹",
        folderHint: "可以是单个模型的文件夹，也可以是装着好几个模型的文件夹，里面会被整体搜索。",
        chooseFolder: "选择文件夹…",
        changeFolder: "更改…",
        rescan: "重新扫描",
        scanning: "正在扫描…",
        ...
        noneFound: "这个文件夹里没有 {family} 模型。",
        noneFoundHint: "先确认上面选的种类，再确认文件夹是不是导出工具写出来的那一个。",
        entry: "入口文件",
        ...
        blockedHint: "缺文件的模型默认不勾选。勾上它就按现状导入。",
        problemCount: {
            one: "{count} 个问题",
            other: "{count} 个问题",
        },
        problem: {
            ...
            unusableReference: "{role}“{raw}”在这个文件夹之外，不会随它一起复制。",
            manifestUnreadable: "读不出 {path}。",
            atlasMissing: "骨架旁边没有图集，应当有 {path}。",
            atlasEmpty: "{path} 没有指明任何图片。",
            nestedModel: "里面还有一个模型 {path}，会被这个文件夹一并带进来。",
        },
        role: {
            moc: "模型文件",
            texture: "贴图",
        ...
        unreadable: "读不出这个文件夹。",
        tooManyFiles: "这个文件夹里有 {count} 个文件，太多了，没法逐个核对。请选到模型所在的那一层。",
    },
    menu: {
        newGroup: "新建分组",
        newSubGroup: "新建子分组",
