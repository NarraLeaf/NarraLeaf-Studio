...
export const storyInspector = {
    ...
    transitionHint: {
        ...
        darkness: "在起始暗度上换图，再动到结束暗度；1 → 0 是从黑场中浮现。亮度只在过渡期间有效",
        throughColor: "用纯色盖住画面，停留一段时间再显露新图片；淡入黑／白、光圈至黑场、闪白（不保持）都用它",
