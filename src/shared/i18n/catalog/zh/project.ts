...
export const project = {
    ...
    settings: {
        ...
        videoModeTitle: "视频设置",
        videoModeDescription: "自动只用一个质量值，高级直接设置参数",
        videoCrfTitle: "CRF",
        videoCrfDescription: "VP9 的恒定质量参数，数值越低画质越好、体积越大",
        videoMaxHeightTitle: "最大高度",
